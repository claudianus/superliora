    ...
    try {
      writeHumanWritingFixture(workDir, {
        contract: [
          ...
          'product UX microcopy uses friendly 해요체, active wording, positive-first recovery, specific CTAs',
          'institutional corporate copy uses formal 합니다/습니다 endings, proof before emotion, future-facing continuity',
          'style-analysis inputs only; do not copy source passages or claim official affiliation',
        ...
        humanWriting: [
          ...
          'Classify Korean prose into a surface-specific voice lane before rewriting.',
          ...
          'Run a second-pass rewrite or deterministic cleanup when available, then reread the result for changed meaning.',
        ],
      });
