...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: '/status: context, Context OS, micro-clear, privacy/ZDR, web/Context7, media, LioraBench', priority: 3, solo: true },
  ...
  { text: '/bench: LioraBench score, loop trend, next bounded rerun', priority: 2, solo: true },
