...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro50/keep2/min16 · async48 · handoff55 · soft60 · maxRecent8 · reserved32k · spec2k · recompact1.5 · swarm750/26k/inline180 · pblock18/9 · hard86 · abs120k', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 12k with 350-char previews — /compact if still high', priority: 2, solo: true },
