...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro44/keep2/min6 · async32 · handoff40 · soft43 · maxRecent4 · reserved16k · spec800 · recompact1.0 · swarm350/10k/inline60 · pblock8/4 · hard70 · abs65k · tool3.5k/60 · cmdPreview4 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 3.5k with 60-char previews — /compact if still high', priority: 2, solo: true },
