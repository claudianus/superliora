...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro6/keep2/min2 · async1 · handoff1.5 · soft1.1 · maxRecent3 · reserved120 · spec40 · recompact0.05 · swarm22/1k/inline3 · pblock1.2/0.4 · hard36 · abs8k · tool5/2 · cmdPreview2 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 5 with 2-char previews — /compact if still high', priority: 2, solo: true },
