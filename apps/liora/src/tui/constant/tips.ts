...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro18/keep2/min2 · async1 · handoff2 · soft1.1 · maxRecent3 · reserved400 · spec120 · recompact0.2 · swarm40/1k/inline6 · pblock2.2/0.8 · hard41 · abs14k · tool12/2 · cmdPreview2 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 12 with 2-char previews — /compact if still high', priority: 2, solo: true },
