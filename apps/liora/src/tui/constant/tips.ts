...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro48/keep2/min10 · async38 · handoff42 · soft49 · maxRecent4 · reserved20k · spec800 · recompact1.0 · swarm450/14k/inline80 · pblock10/5 · hard76 · abs80k · tool5k/90 · cmdPreview5 · resultPreview2 · thinking2', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 5k with 90-char previews — /compact if still high', priority: 2, solo: true },
