...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro50/keep3/min24 · async50 · handoff58 · soft62 · maxRecent10 · reserved36k · spec2.5k · recompact2 · swarm750/26k/inline180 · pblock20/10 · hard88 · abs130k', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 14k with 400-char previews — /compact if still high', priority: 2, solo: true },
