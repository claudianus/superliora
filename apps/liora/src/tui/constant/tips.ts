...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro50/keep2/min16 · async46 · handoff50 · soft58 · maxRecent7 · reserved30k · spec1.5k · recompact1.2 · swarm650/22k/inline150 · pblock16/8 · hard86 · abs110k · tool8k/250', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 8k with 250-char previews — /compact if still high', priority: 2, solo: true },
