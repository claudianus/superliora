...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro48/keep2/min10 · async40 · handoff42 · soft51 · maxRecent4 · reserved20k · spec1.0k · recompact1.0 · swarm450/14k/inline80 · pblock10/5 · hard78 · abs85k · tool6k/120 · cmdPreview6 · resultPreview2 · thinking2', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 6k with 120-char previews — /compact if still high', priority: 2, solo: true },
