...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro50/keep8 · async60 · handoff65 · soft72 · hard92 · abs180k', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 32k with 1k previews — /compact if still high', priority: 2, solo: true },
