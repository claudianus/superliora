...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro50/keep8/min64 · async60 · handoff65 · soft70 · maxRecent14 · reserved48k · spec5k · recompact3.5 · swarm750/26k/inline180 · pblock28/14 · hard92 · abs160k', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 24k with 800-char previews — /compact if still high', priority: 2, solo: true },
