...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro35/keep2/min3 · async1 · handoff5 · soft1.2 · maxRecent3 · reserved2.5k · spec600 · recompact0.8 · swarm80/2.5k/inline16 · pblock5/2.5 · hard50 · abs30k · tool70/2 · cmdPreview3 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 70 with 2-char previews — /compact if still high', priority: 2, solo: true },
