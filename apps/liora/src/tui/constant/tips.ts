...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro1/keep1/min1 · async1 · handoff1.0012 · soft1.001 · maxRecent1 · reserved1 · spec1 · recompact0.0000002 · swarm3/1k/inline3 · pblock0.002/0.002 · hard1.002 · abs1 · tool2/2 · cmdPreview2 · resultPreview1 · thinking1', priority: 3, solo: true },
  ...
  { text: 'premium particle rails push denser comets + 16-cell trails at 12ms — zero config spectacle', priority: 1, solo: true },
