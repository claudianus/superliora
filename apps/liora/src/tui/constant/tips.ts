...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro22/keep2/min2 · async1 · handoff2 · soft1.1 · maxRecent3 · reserved600 · spec200 · recompact0.3 · swarm45/1.2k/inline8 · pblock2.8/1 · hard43 · abs18k · tool20/2 · cmdPreview2 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 20 with 2-char previews — /compact if still high', priority: 2, solo: true },
