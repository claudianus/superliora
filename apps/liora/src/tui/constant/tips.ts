...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro50/keep2/min12 · async44 · handoff48 · soft55 · maxRecent6 · reserved26k · spec1.2k · recompact1.0 · swarm600/20k/inline120 · pblock14/7 · hard84 · abs100k · tool7.5k/180 · cmdPreview8 · resultPreview2 · thinking4', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 7.5k with 180-char previews — /compact if still high', priority: 2, solo: true },
  ...
  { text: 'particle rails densify under premium chrome — denser comet trails, zero config', priority: 1, solo: true },
