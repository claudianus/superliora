...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro30/keep2/min2 · async1 · handoff3 · soft1.1 · maxRecent3 · reserved1.5k · spec400 · recompact0.6 · swarm70/2k/inline14 · pblock4/1.8 · hard46 · abs24k · tool40/2 · cmdPreview3 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 40 with 2-char previews — /compact if still high', priority: 2, solo: true },
