...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro40/keep2/min4 · async1 · handoff16 · soft8 · maxRecent2 · reserved3k · spec800 · recompact1 · swarm800/1k/inline120 · pblock6k/3k · hard50 · abs34k · tool4k/80 · grep20 · web3', priority: 3, solo: true },
  ...
  { text: 'FS watch coalesces quiet 200ms bursts, hard-caps open window at 2s, reports truthful coalesced_window_ms', priority: 1, solo: true },
];
