...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro32/keep2/min2 · async1 · handoff3 · soft1.1 · maxRecent3 · reserved1.5k · spec500 · recompact0.6 · swarm70/2k/inline14 · pblock4.5/2 · hard48 · abs26k · tool50/2 · cmdPreview3 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 50 with 2-char previews — /compact if still high', priority: 2, solo: true },
