...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro1/keep2/min2 · async1 · handoff1.01 · soft1.002 · maxRecent3 · reserved1 · spec1 · recompact0.0000008 · swarm3/1k/inline3 · pblock0.002/0.002 · hard1.015 · abs1 · tool2/2 · cmdPreview2 · resultPreview1 · thinking1', priority: 3, solo: true },
  ...
  { text: 'premium particle rails push denser comets + 9-cell trails at 30ms — zero config spectacle', priority: 1, solo: true },
