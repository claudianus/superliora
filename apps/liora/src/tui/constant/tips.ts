...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro50/keep2/min10 · async42 · handoff44 · soft53 · maxRecent5 · reserved24k · spec1.0k · recompact1.0 · swarm550/18k/inline100 · pblock12/6 · hard80 · abs90k · tool6.5k/140 · cmdPreview7 · resultPreview2 · thinking3', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 6.5k with 140-char previews — /compact if still high', priority: 2, solo: true },
