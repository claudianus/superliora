...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro15/keep2/min2 · async1 · handoff2 · soft1.1 · maxRecent3 · reserved300 · spec100 · recompact0.15 · swarm35/1k/inline5 · pblock2/0.7 · hard40 · abs12k · tool10/2 · cmdPreview2 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 10 with 2-char previews — /compact if still high', priority: 2, solo: true },
