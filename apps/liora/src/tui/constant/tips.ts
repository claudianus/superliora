...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro50/keep2/min10 · async44 · handoff46 · soft55 · maxRecent6 · reserved26k · spec1.0k · recompact1.0 · swarm600/20k/inline120 · pblock14/7 · hard84 · abs100k · tool7k/160 · cmdPreview8 · resultPreview2 · thinking3', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 7k with 160-char previews — /compact if still high', priority: 2, solo: true },
