...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro42/keep2/min5 · async28 · handoff36 · soft38 · maxRecent3 · reserved12k · spec800 · recompact1.0 · swarm300/8k/inline50 · pblock8/4 · hard68 · abs60k · tool3k/50 · cmdPreview4 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 3k with 50-char previews — /compact if still high', priority: 2, solo: true },
