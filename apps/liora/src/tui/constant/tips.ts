...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro25/keep2/min2 · async1 · handoff2.5 · soft1.1 · maxRecent3 · reserved600 · spec250 · recompact0.3 · swarm50/1.5k/inline10 · pblock3/1.2 · hard43 · abs18k · tool22/2 · cmdPreview2 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 22 with 2-char previews — /compact if still high', priority: 2, solo: true },
