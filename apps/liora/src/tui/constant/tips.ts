...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro44/keep2/min6 · async34 · handoff40 · soft44 · maxRecent4 · reserved16k · spec800 · recompact1.0 · swarm350/10k/inline60 · pblock8/4 · hard72 · abs70k · tool4k/70 · cmdPreview4 · resultPreview1 · thinking2', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 4k with 70-char previews — /compact if still high', priority: 2, solo: true },
