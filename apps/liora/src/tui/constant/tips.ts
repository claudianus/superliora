...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro40/keep2/min4 · async3 · handoff16 · soft13 · maxRecent3 · reserved3k · spec800 · recompact1.0 · swarm100/3k/inline20 · pblock6/3 · hard50 · abs34k · tool800/15 · cmdPreview4 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 800 with 15-char previews — /compact if still high', priority: 2, solo: true },
