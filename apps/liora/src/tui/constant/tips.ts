...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro1/keep2/min2 · async1 · handoff1.1 · soft1.1 · maxRecent3 · reserved6 · spec2 · recompact0.002 · swarm3/1k/inline3 · pblock0.18/0.04 · hard23 · abs600 · tool2/2 · cmdPreview2 · resultPreview1 · thinking1', priority: 3, solo: true },
