...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro20/keep2/min2 · async1 · handoff2 · soft1.1 · maxRecent3 · reserved500 · spec150 · recompact0.25 · swarm40/1k/inline6 · pblock2.5/0.9 · hard42 · abs15k · tool15/2 · cmdPreview2 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 15 with 2-char previews — /compact if still high', priority: 2, solo: true },
