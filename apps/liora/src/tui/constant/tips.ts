...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro28/keep2/min2 · async1 · handoff3 · soft1.1 · maxRecent3 · reserved800 · spec350 · recompact0.4 · swarm60/1.8k/inline12 · pblock3.5/1.5 · hard44 · abs20k · tool30/2 · cmdPreview2 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 30 with 2-char previews — /compact if still high', priority: 2, solo: true },
