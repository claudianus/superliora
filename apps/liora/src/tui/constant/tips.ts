...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'context ladder: micro8/keep2/min2 · async1 · handoff1.6 · soft1.1 · maxRecent3 · reserved150 · spec50 · recompact0.06 · swarm25/1k/inline3 · pblock1.4/0.45 · hard37 · abs9k · tool6/2 · cmdPreview2 · resultPreview1 · thinking1', priority: 3, solo: true },
  { text: 'tool outputs auto-trim at 6 with 2-char previews — /compact if still high', priority: 2, solo: true },
