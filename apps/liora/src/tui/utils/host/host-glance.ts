...
export const HOST_SOVEREIGN_UMBRELLA_TIP =
  `${SOVEREIGN_UMBRELLA_ENV}=1 — umbrella sovereign reform: core profile default · hide legacy tool aliases · codemap session-start warm · fleet+mission dual-emit (WS/RPC only — never journal).`;
