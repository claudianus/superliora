...
import { renderParticleRail } from '#/tui/utils/appearance-particles';
import { renderPulseText } from '#/tui/utils/appearance-pulse';
import { renderShimmerPrefix } from '#/tui/utils/appearance-shimmer';
