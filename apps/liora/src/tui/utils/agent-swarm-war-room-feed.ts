import { collapseWhitespace } from '#/tui/utils/agent-swarm-cell-render';
import type { SwarmOpsFeedTag } from '#/tui/utils/agent-swarm-progress-types';
import type { WarRoomDebateTurn } from '#/tui/utils/agent-swarm-header-render';
import { WAR_ROOM_DEBATE_REEL_MAX } from '#/tui/utils/agent-swarm-progress-constants';
