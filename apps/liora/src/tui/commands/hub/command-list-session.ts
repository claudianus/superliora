...
export const BUILTIN_SLASH_COMMANDS_SESSION = [
{
  ...
  },
  {
    name: 'jobs',
    aliases: [],
    description: 'Conductor Job desk — list parallel jobs',
    priority: 88,
    argumentHint: '[job_id]',
    availability: 'always',
  },
  {
    name: 'job',
    aliases: [],
    description: 'Conductor Job — inspect / resume / cancel / inbox / gc',
    priority: 88,
    argumentHint: 'list | inbox | resume [id] | cancel <id> | inspect <id> | gc',
