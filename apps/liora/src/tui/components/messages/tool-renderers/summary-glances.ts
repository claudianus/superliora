...
export const GLANCE_SAMPLES = 3;

export type GlanceFn = (
...
export const grepGlance: GlanceFn = (_toolCall, result) => {
...
export const globGlance: GlanceFn = (_toolCall, result) => {
  const lines = nonEmptyLines(result.output);
  if (lines.length === 0) return '';
...
export const lioraReadGlance: GlanceFn = (_toolCall, result) => {
...
export const lioraSymbolGlance: GlanceFn = (_toolCall, result) => {
...
export const lioraTreeGlance: GlanceFn = (_toolCall, result) => {
  const samples: string[] = [];
  for (const line of result.output.split('\n')) {
    const trimmed = line.trim();
...
export const lioraExpandGlance: GlanceFn = (toolCall, result) => {
...
export const lioraCallgraphGlance: GlanceFn = (toolCall, result) => {
...
export const searchSkillGlance: GlanceFn = (_toolCall, result) => {
  const names: string[] = [];
  for (const line of result.output.split('\n')) {
...
export const searchExpertGlance: GlanceFn = (_toolCall, result) => {
  const names: string[] = [];
  for (const line of result.output.split('\n')) {
    const m = /name="([^"]+)"/.exec(line);
...
export const skillGlance: GlanceFn = (toolCall, result) => {
  const skill =
...
export const memoryGlance: GlanceFn = (toolCall, result) => {
  const action =
...
export const nextPhaseGlance: GlanceFn = (_toolCall, result) => {
...
export const recordInterviewFindingGlance: GlanceFn = (toolCall, result) => {
  const question =
...
export const getCurrentTimeGlance: GlanceFn = (_toolCall, result) => {
  try {
...
export const askUserQuestionGlance: GlanceFn = (_toolCall, result) => {
  try {
...
export const lioraReviewGlance: GlanceFn = (_toolCall, result) => {
...
export const taskListGlance: GlanceFn = (_toolCall, result) => {
...
export const taskOutputGlance: GlanceFn = (toolCall, result) => {
...
export const cronListGlance: GlanceFn = (_toolCall, result) => {
...
export const cronCreateGlance: GlanceFn = (_toolCall, result) => {
...
export const fetchGlance: GlanceFn = (toolCall, result) => {
