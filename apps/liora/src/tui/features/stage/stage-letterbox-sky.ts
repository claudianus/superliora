...
} from '#/tui/features/stage/stage-letterbox-sky-burst';
import {
  insideHole,
  letterboxArea,
...
} from '#/tui/features/stage/stage-letterbox-sky-geometry';
import {
  ...
  type SpawnSector,
} from '#/tui/features/stage/stage-letterbox-sky-meteor';
import {
  applySkyToLetterboxRegions,
  resetLetterboxSkyRegionCacheForTests,
} from '#/tui/features/stage/stage-letterbox-sky-regions';
