...
import {
  ...
  setStoryCellRow,
  waterCell,
} from '#/tui/features/idle-scene/idle-scene-canvas';
import {
...
} from '#/tui/features/idle-scene/idle-scene-ambient';
import {
  paintFishFromSnapshot,
  paintFishSchool,
  paintFoodFromSnapshot,
  paintFxFromSnapshot,
} from '#/tui/features/idle-scene/idle-scene-fish';
import {
  resolveAquariumPalette,
  type AquariumPalette,
  type IdleSceneColors,
} from '#/tui/features/idle-scene/idle-scene-palette';
import { paintAirStone, paintCoral, paintJellyfish, paintSeahorse, paintSeaweed } from '#/tui/features/idle-scene/idle-scene-scenery';
import type { IdleTankSnapshot } from '#/tui/features/idle-scene/idle-tank-sim';

export * from '#/tui/features/idle-scene/idle-scene-sprites';
export {
  ANSI_RESET,
  blitAt,
  blitCentered,
...
export type { AquariumPalette, IdleSceneColors } from '#/tui/features/idle-scene/idle-scene-palette';
export {
  JEWEL_TANK_DARK,
  JEWEL_TANK_LIGHT,
  resolveAquariumPalette,
...
export { paintJellyfish, paintSeahorse } from '#/tui/features/idle-scene/idle-scene-scenery';
