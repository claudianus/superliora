/**
 * Shared helpers for `liora server …` subcommands.
 *
...
import type { ServerLogLevel } from '@superliora/server';
...
/** Filename (under SUPERLIORA_HOME) of the persistent server bearer token. */
 ...
 * is the CLI's own SUPERLIORA_HOME resolution (`getDataDir()`).
 *
