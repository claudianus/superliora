...
export const STRINGS_TUI_EN: Readonly<Record<string, string>> = {
  ...
  'tui.common.cancelCtrlC': '{chord} cancel',
  ...
  'tui.history.searchToast': 'Clear the prompt first ({chord} searches history)',
  'tui.history.waitToast': 'Wait for the turn to finish, or {chord} to stop',
  ...
  'tui.footer.next.history': 'next: {chord} cycles transcript density (minimal→full)',
  ...
  'tui.footer.exitConfirmCtrlC': 'Press {chord} again to exit',
  ...
  'tui.help.shortcut.quota': 'Open / close the live remaining-credits (Quota) overlay',
  'tui.help.shortcut.plan': 'Start Plan mode and browse the plan (empty prompt; P/Esc closes the overlay, /plan exits)',
  ...
  'tui.tip.altI': 'Alt+I opens the Conductor Inbox (questions waiting on you)',
  'tui.tip.altB': 'Alt+B focuses the Intent Composer brief slots',
  'tui.tip.quota': 'Q (empty prompt) opens the Quota overlay; press Q again to close it',
  'tui.tip.plan': 'P (empty prompt) starts Plan mode and opens the plan',
  'tui.tip.shiftEnter': 'shift+enter: newline',
  'tui.tip.ctrlC': '{chord}: cancel',
  ...
  'tui.tip.ctrlK': '{chord}: open Command Hub — modes, model, sessions',
  'tui.tip.help': '{chord} or ?: Command Hub (slash commands still work)',
...
export const STRINGS_TUI_KO: Readonly<Record<string, string>> = {
  ...
  'tui.common.cancelCtrlC': '{chord} 취소',
  ...
  'tui.history.searchToast': '먼저 프롬프트를 비우세요 ({chord}가 히스토리를 검색합니다)',
  'tui.history.waitToast': '턴이 끝날 때까지 기다리거나 {chord}로 중지하세요',
  ...
  'tui.footer.next.history': '다음: {chord}로 트랜스크립트 밀도 순환 (minimal→full)',
  ...
  'tui.help.shortcut.quota': '남은 크레딧(Quota) 오버레이 열기/닫기',
  'tui.help.shortcut.plan': 'Plan 모드 시작 후 플랜 브라우저 열기 (빈 프롬프트; P/Esc로 닫고, /plan으로 종료)',
  ...
  'tui.tip.altI': 'Alt+I로 Conductor Inbox 열기 (답변 대기 질문)',
  'tui.tip.altB': 'Alt+B로 Intent Composer brief 슬롯 포커스',
  'tui.tip.quota': 'Q(빈 프롬프트)로 Quota 오버레이 열기 · 다시 Q를 누르면 닫힘',
  'tui.tip.plan': 'P(빈 프롬프트)로 Plan 모드 시작 · 플랜 브라우저 열기',
  'tui.tip.shiftEnter': 'shift+enter: 줄바꿈',
  'tui.tip.ctrlC': '{chord}: 취소',
  ...
  'tui.tip.ctrlK': '{chord}: Command Hub — 모드, 모델, 세션',
  'tui.tip.help': '{chord} 또는 ?: Command Hub (슬래시도 그대로 동작)',
