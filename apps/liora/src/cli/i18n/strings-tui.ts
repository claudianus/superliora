...
export const STRINGS_TUI_EN: Readonly<Record<string, string>> = {
  ...
  'tui.provider.mediaHint': 'Tip: OPENAI_API_KEY / GOOGLE_API_KEY enable image/video · /status checks media/web readiness',
...
export const STRINGS_TUI_KO: Readonly<Record<string, string>> = {
  ...
  'tui.provider.mediaHint': '팁: OPENAI_API_KEY / GOOGLE_API_KEY로 이미지·영상 · /status로 미디어/웹 준비 상태 확인',
