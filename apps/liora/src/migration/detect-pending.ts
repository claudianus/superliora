...
import { detectMigration, type MigrationPlan } from '@superliora/migration-legacy';
...
export interface DetectPendingInput {
   ...
   * `.skip-migration-from-kimi-cli`). The explicit `liora migrate` command sets
 ...
 * into *this* target home. A marker written for a different `SUPERLIORA_HOME`
