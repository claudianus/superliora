...
export const translations: Record<Lang, Translation> = {
  ko: {
    ...
    solution: {
      ...
      body: '일반 프롬프트는 가볍게, 복잡한 작업은 Ultrawork로 전환합니다. UltraPlan interview부터 UltraGoal, research, Swarm decision, verification, learning까지 이어집니다.',
    },
    terminal: [
      { cmd: 'liora --version', output: 'SuperLiora 0.20.1' },
      { cmd: 'liora plan migrate-to-nextjs', output: 'UltraPlan interview: requirements, constraints, risks' },
      { cmd: 'liora goal --yes', output: 'UltraGoal locked: stateless auth service (true/false)' },
      { cmd: 'liora research --providers', output: 'Research loop: API docs, release notes, CVEs' },
      { cmd: 'liora work --ultra', output: 'Ultrawork session engaged. Swarm ready.' },
      { cmd: 'liora verify', output: 'Verification: 14 tests passed, 2 risks noted' },
      { cmd: 'liora remember', output: 'Saved to Liora Recall.' },
    ],
    ultra: {
      kicker: 'Ultra workflow',
      title: '계획부터 검증까지 이어지는 실행 구조',
      body: 'Shift-Tab Ultrawork mode는 복잡한 요청을 UltraPlan interview로 먼저 좁히고, true/false로 검증 가능한 UltraGoal을 만든 뒤 research, Swarm decision, integration, verification 순서로 진행합니다.',
    ...
    cta: {
      ...
      body: 'SuperLiora를 설치하고 첫 UltraWork를 시작해 보세요.',
      install: '지금 설치',
      github: 'GitHub 보기',
    },
    footer: {
  ...
  en: {
    ...
    solution: {
      ...
      body: 'Use normal prompts for light tasks, and switch to Ultrawork for complex ones. From UltraPlan interview to UltraGoal, research, Swarm decision, verification, and learning.',
    },
    terminal: [
      { cmd: 'liora --version', output: 'SuperLiora 0.20.1' },
      { cmd: 'liora plan migrate-to-nextjs', output: 'UltraPlan interview: requirements, constraints, risks' },
    ...
    ultra: {
      ...
      body: 'Shift-Tab Ultrawork mode first narrows complex requests with an UltraPlan interview, creates a true/false verifiable UltraGoal, then proceeds through research, Swarm decision, integration, and verification.',
      copyTitle: 'Plan → Goal → Research → Swarm → Verify → Learn',
      copyBody:
    ...
    cta: {
      ...
      body: 'Install SuperLiora and start your first UltraWork.',
      install: 'Install now',
      github: 'View on GitHub',
    },
    footer: {
