...
const SESSION_TO_AGENT_ALLOWLIST = new Set([
  ...
  'session/rpc.ts',
  'session/session-agent-lifecycle.ts',
  'session/session-close-lifecycle.ts',
  'session/session-plugin-reminder.ts',
  'session/session-resources.ts',
  'session/session-types.ts',
  'session/session-workspace-dirs.ts',
  'session/store/session-store.ts',
  'session/subagent-child-config.ts',
  'session/subagent-completion-flow.ts',
  'session/subagent-errors.ts',
  'session/subagent-events.ts',
  'session/subagent-host.ts',
  'session/subagent-progress-preview.ts',
  'session/subagent-result-contract.ts',
  'session/subagent-run-lifecycle.ts',
  'session/subagent-side-channel.ts',
  'session/subagent-telemetry.ts',
  'session/subagent-verification-gate.ts',
  'session/trace.ts',
