...
**A terminal-centric AI coding harness that carries long, complex development flows from plan to finish.**  
...
SuperLiora is a self-contained AI coding harness that runs in your terminal. It connects planning, research, goal management, parallel execution, verification, memory, documentation, browser use, and computer use into one workflow.

For long sessions, it preserves context, leaves evidence-backed decisions, and helps you focus on the next step.
...
- **Premium TUI** — pilots the terminal with Neon Noir / Daylight palettes and keyboard-first navigation.
...
긴 세션에서도 맥락을 보존하고, 근거 있는 결정을 남기며, 다음 단계에 집중할 수 있도록 돕습니다.
