...
describe('FullCompaction', () => {
  ...
  it('blocks the turn until auto compaction finishes', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [wire] context.append_loop_event   { "event": { "type": "step.end", "uuid": "<uuid-1>", "turnId": "0", "step": 1, "usage": { "inputOther": 446, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "finishReason": "end_turn", "providerRouteSelection": { "modelAlias": "kimi-code", "providerModel": "kimi-code" } }, "time": "<time>" }
      [emit] turn.step.completed         { "turnId": 0, "step": 1, "stepId": "<uuid-1>", "usage": { "inputOther": 446, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "finishReason": "end_turn", "providerRouteSelection": { "modelAlias": "kimi-code", "providerModel": "kimi-code" } }
      [wire] usage.record                { "model": "kimi-code", "usage": { "inputOther": 446, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "turn", "time": "<time>" }
      [emit] agent.status.updated        { "model": "kimi-code", "contextTokens": 457, "maxContextTokens": 256000, "contextUsage": 0.00178515625, "planMode": false, "swarmMode": false, "premiumQualityMode": false, "permission": "manual", "usage": { "byModel": { "kimi-code": { "inputOther": 1165, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 1165, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 446, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "providerRoute": null, "contextOS": { "pageCount": 1, "readyPageCount": 0, "needsRehydrationPageCount": 1, "atRiskPageCount": 0, "missingEvidencePageCount": 0, "evidenceIdRecallScore": 1, "latestContinuityStatus": "needs_rehydration" }, "microCompaction": null }
  ...
  it('compacts and retries when the provider reports context overflow', async () => {
    ...
    expect(inputs).toMatchInlineSnapshot(`
      ...
      - Continue the active user task from the compacted state.
      last_known_state:
      - 2 old messages were compacted; 95 estimated tokens remain in the recent live context.
      decisions:
      - None captured during compaction.
      files_touched:
      - None captured during compaction.
