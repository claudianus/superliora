...
describe('FullCompaction', () => {
  ...
  it('runs manual compaction and applies the compacted context', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated       { "model": "kimi-code", "contextTokens": 345, "maxContextTokens": 256000, "contextUsage": 0.00134765625, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "kimi-code": { "inputOther": 709, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 709, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "providerRoute": null }
  ...
  it('keeps messages appended while compacting an unchanged prefix', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated       { "model": "kimi-code", "contextTokens": 327, "maxContextTokens": 256000, "contextUsage": 0.00127734375, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "kimi-code": { "inputOther": 676, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 676, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "providerRoute": null }
  ...
  it('blocks the turn until auto compaction finishes', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated        { "model": "kimi-code", "contextTokens": 342, "maxContextTokens": 256000, "contextUsage": 0.0013359375, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "kimi-code": { "inputOther": 675, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 675, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "providerRoute": null }
      [wire] full_compaction.complete    { "time": "<time>" }
  ...
  it('emits context.overflow and terminates the turn after too many auto compactions', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated        { "model": "mock-model", "contextTokens": 310, "maxContextTokens": 1000000, "contextUsage": 0.00031, "planMode": false, "swarmMode": false, "permission": "manual", "usage": { "byModel": { "mock-model": { "inputOther": 641, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 641, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "providerRoute": null }
      [wire] full_compaction.complete    { "time": "<time>" }
    ...
    `);
    expect(ctx.newEvents()).toMatchInlineSnapshot(
      `[emit] error   { "code": "context.overflow", "message": "Compaction limit exceeded (1)", "name": "LioraError", "details": { "maxCompactions": 1, "turnId": 0 }, "retryable": true }`,
    );
    expect(ctx.llmInputs()).toMatchInlineSnapshot(`
      call 1:
        system: <system-prompt>
