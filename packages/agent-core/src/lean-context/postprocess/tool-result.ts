...
function postprocessBash(
  ...
  const shouldCompress =
    ...
    /\b(?:pnpm|npm|yarn|cargo|vitest|jest|pytest|go\s+test|tsc|eslint|oxlint|oxfmt|ruff|mypy|pyright|biome|clippy|prettier|black|isort|rustfmt|gofmt|clang-format|git|docker)\b/u.test(
      command,
    );
