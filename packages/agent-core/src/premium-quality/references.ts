...
export const PREMIUM_VISUAL_LAYOUT_TEMPLATES_2026 = [
  ...
  '4. **Product-in-hero** — embedded interactive demo, video loop, or live widget above fold (Linear-style pattern).',
...
export const PREMIUM_VISUAL_PHOTO_CATALOG = [
  ...
  '**Treatment modifiers** (append to Picsum URL): cinematic `?grayscale&blur=2` under overlay; soft `?blur=1` behind glass.',
  '**Deterministic SVG avatars** (testimonials/users/NPCs): `https://api.dicebear.com/10.x/notionists/svg?seed={id}` (+ lorelei/shapes/initials).',
