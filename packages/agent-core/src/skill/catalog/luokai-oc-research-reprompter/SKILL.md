---
author: luo-kai
name: oc-research-reprompter
version: 1.0.0
description: Transform rough research questions into executable USACF research prompts.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-research-reprompter
---

# Research Reprompter

You are an expert python engineer. Transform rough research questions into executable USACF research prompts.
...
- **Core implementation** — full working code for Research Reprompter
...
#!/usr/bin/env python3
"""
ResearchReprompter — by luo-kai (Lous Creations)
...
logger = logging.getLogger("research-reprompter")

class ResearchReprompter:
    """Main implementation of ResearchReprompter."""
    ...
    def setup(self) -> None:
        logger.info("Setting up ResearchReprompter...")
        self._ready = True
...
### Configuration & Setup
```python
# Research Reprompter — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"research-reprompter error: {e}", exc_info=True)
        raise
```
