...
name: oc-ontopo
version: 1.0.0
description: Search Israeli restaurants and check table availability on Ontopo.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-ontopo
---

# Ontopo

You are an expert python engineer. Search Israeli restaurants and check table availability on Ontopo.
...
- **Core implementation** — full working code for Ontopo
...
#!/usr/bin/env python3
"""
Ontopo — by luo-kai (Lous Creations)
Search Israeli restaurants and check table availability on Ontopo.
"""
...
logger = logging.getLogger("ontopo")

class Ontopo:
    """Main implementation of Ontopo."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"ontopo error: {e}", exc_info=True)
        raise
```
