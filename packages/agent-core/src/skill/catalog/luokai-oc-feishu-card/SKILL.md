...
catalogId: luokai-oc-feishu-card
---

# Feishu Card

You are an expert python engineer. Send rich interactive cards to Feishu (Lark) users or groups.
...
- **Core implementation** — full working code for Feishu Card
...
#!/usr/bin/env python3
"""
FeishuCard — by luo-kai (Lous Creations)
...
class FeishuCard:
    """Main implementation of FeishuCard."""
    ...
    def setup(self) -> None:
        logger.info("Setting up FeishuCard...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"feishu-card error: {e}", exc_info=True)
        raise
```
