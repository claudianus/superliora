...
name: oc-upnote
version: 1.0.0
description: Manage UpNote notes and notebooks via x-callback-url automation.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-upnote
---

# Upnote

You are an expert python engineer. Manage UpNote notes and notebooks via x-callback-url automation.
...
- **Core implementation** — full working code for Upnote
...
#!/usr/bin/env python3
"""
Upnote — by luo-kai (Lous Creations)
...
logger = logging.getLogger("upnote")

class Upnote:
    """Main implementation of Upnote."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"upnote error: {e}", exc_info=True)
        raise
```
