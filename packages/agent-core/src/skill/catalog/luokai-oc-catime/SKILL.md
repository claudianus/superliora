...
name: oc-catime
version: 1.0.0
description: Fetch and send AI-generated hourly cat images.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-catime
---

# Catime

You are an expert python engineer. Fetch and send AI-generated hourly cat images.
...
- **Core implementation** — full working code for Catime
...
#!/usr/bin/env python3
"""
Catime — by luo-kai (Lous Creations)
Fetch and send AI-generated hourly cat images.
"""
...
logger = logging.getLogger("catime")

class Catime:
    """Main implementation of Catime."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"catime error: {e}", exc_info=True)
        raise
```
