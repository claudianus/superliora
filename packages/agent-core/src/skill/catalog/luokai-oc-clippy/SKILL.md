...
catalogId: luokai-oc-clippy
---

# Clippy

You are an expert python engineer. Microsoft 365 / Outlook CLI for calendar and email.
...
- **Core implementation** — full working code for Clippy
...
#!/usr/bin/env python3
"""
Clippy — by luo-kai (Lous Creations)
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"clippy error: {e}", exc_info=True)
        raise
```
