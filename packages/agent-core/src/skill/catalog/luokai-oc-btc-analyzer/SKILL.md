---
author: luo-kai
name: oc-btc-analyzer
version: 1.0.0
description: Fetch live BTCUSDT 15m candles from Binance public API and analyze market direction UP/DOWN/SKIP using EMA20.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-btc-analyzer
---

# Btc Analyzer

You are an expert python engineer. Fetch live BTCUSDT 15m candles from Binance public API and analyze market direction UP/DOWN/SKIP using EMA20.
...
- **Core implementation** — full working code for Btc Analyzer
...
#!/usr/bin/env python3
"""
BtcAnalyzer — by luo-kai (Lous Creations)
Fetch live BTCUSDT 15m candles from Binance public API and analyze market direct
"""
...
logger = logging.getLogger("btc-analyzer")

class BtcAnalyzer:
    """Main implementation of BtcAnalyzer."""
    ...
    def setup(self) -> None:
        logger.info("Setting up BtcAnalyzer...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"btc-analyzer error: {e}", exc_info=True)
        raise
```
