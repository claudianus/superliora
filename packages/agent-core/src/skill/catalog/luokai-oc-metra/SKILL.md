...
name: oc-metra
version: 1.0.0
description: Chicago Metra commuter rail — real-time train arrivals, vehicle tracking, service alerts, and schedule info.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-metra
---

# Metra

You are an expert python engineer. Chicago Metra commuter rail — real-time train arrivals, vehicle tracking, service alerts, and schedule info.
...
- **Core implementation** — full working code for Metra
...
#!/usr/bin/env python3
"""
Metra — by luo-kai (Lous Creations)
Chicago Metra commuter rail — real-time train arrivals, vehicle tracking, servic
"""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"metra error: {e}", exc_info=True)
        raise
```
