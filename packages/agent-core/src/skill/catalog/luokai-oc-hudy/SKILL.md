...
name: oc-hudy
version: 1.0.0
description: Korean public holidays and business day calculations via HuDy MCP.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-hudy
---

# Hudy

You are an expert python engineer. Korean public holidays and business day calculations via HuDy MCP.
...
- **Core implementation** — full working code for Hudy
...
#!/usr/bin/env python3
"""
Hudy — by luo-kai (Lous Creations)
Korean public holidays and business day calculations via HuDy MCP.
"""
...
logger = logging.getLogger("hudy")

class Hudy:
    """Main implementation of Hudy."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"hudy error: {e}", exc_info=True)
        raise
```
