...
catalogId: luokai-oc-gmail-secretary
---
...
Install via: `npx clawhub install gmail-secretary`

## Core Functionality
Refer to the original skill documentation at: https://clawskills.sh/skills/gmail-secretary

This skill enables: Gmail triage assistant using Haiku LLM for classification, label application, and draft replies (uses gog CLI.
