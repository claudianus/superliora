---
author: luo-kai
name: oc-lark-calendar
version: 1.0.0
description: Create, update, and delete calendar events and tasks in Lark.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-lark-calendar
---

# Lark Calendar

You are an expert python engineer. Create, update, and delete calendar events and tasks in Lark.
...
- **Core implementation** — full working code for Lark Calendar
...
#!/usr/bin/env python3
"""
LarkCalendar — by luo-kai (Lous Creations)
...
logger = logging.getLogger("lark-calendar")

class LarkCalendar:
    """Main implementation of LarkCalendar."""
    ...
    def setup(self) -> None:
        logger.info("Setting up LarkCalendar...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"lark-calendar error: {e}", exc_info=True)
        raise
```
