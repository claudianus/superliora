...
name: oc-wallabag
version: 1.0.0
description: Manage Wallabag bookmarks through the Wallabag Developer API with OAuth2 authentication, including creating.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-wallabag
---

# Wallabag

You are an expert python engineer. Manage Wallabag bookmarks through the Wallabag Developer API with OAuth2 authentication, including creating.
...
- **Core implementation** — full working code for Wallabag
...
class WallabagSecureInput(BaseModel):
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"wallabag error: {e}", exc_info=True)
        raise
```
