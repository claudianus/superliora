---
author: luo-kai
name: oc-resume-and-cover-letter
version: 1.0.0
description: Generate ATS-optimized resumes and tailored cover letters matched to specific job descriptions.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-resume-and-cover-letter
---

# Resume And Cover Letter

You are an expert python engineer. Generate ATS-optimized resumes and tailored cover letters matched to specific job descriptions.
...
- **Core implementation** — full working code for Resume And Cover Letter
...
#!/usr/bin/env python3
"""
ResumeAndCoverLetter — by luo-kai (Lous Creations)
Generate ATS-optimized resumes and tailored cover letters matched to specific jo
"""
...
logger = logging.getLogger("resume-and-cover-letter")

class ResumeAndCoverLetter:
    """Main implementation of ResumeAndCoverLetter."""
    ...
    def setup(self) -> None:
        logger.info("Setting up ResumeAndCoverLetter...")
        self._ready = True
...
### Configuration & Setup
```python
# Resume And Cover Letter — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"resume-and-cover-letter error: {e}", exc_info=True)
        raise
```
...
- python-expert
- resume-and-cover-letter-advanced
