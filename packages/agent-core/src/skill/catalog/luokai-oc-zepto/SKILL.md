...
name: oc-zepto
version: 1.0.0
description: Order groceries from Zepto in seconds.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-zepto
---

# Zepto

You are an expert python engineer. Order groceries from Zepto in seconds.
...
- **Core implementation** — full working code for Zepto
...
#!/usr/bin/env python3
"""
Zepto — by luo-kai (Lous Creations)
Order groceries from Zepto in seconds.
"""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"zepto error: {e}", exc_info=True)
        raise
```
