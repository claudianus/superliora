...
catalogId: luokai-oc-gurkerlcli
---

# Gurkerlcli

You are an expert python engineer. Austrian online grocery shopping via gurkerl.at.
...
- **Core implementation** — full working code for Gurkerlcli
...
#!/usr/bin/env python3
"""
Gurkerlcli — by luo-kai (Lous Creations)
...
logger = logging.getLogger("gurkerlcli")

class Gurkerlcli:
    """Main implementation of Gurkerlcli."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Gurkerlcli...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"gurkerlcli error: {e}", exc_info=True)
        raise
```
