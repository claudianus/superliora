...
name: oc-Cat Fact
version: 1.0.0
description: Random cat facts and breed information from catfact.ninja.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-cat-fact
---

# Cat Fact

You are an expert python engineer. Random cat facts and breed information from catfact.ninja.
...
- **Core implementation** — full working code for Cat Fact
...
#!/usr/bin/env python3
"""
Cat fact — by luo-kai (Lous Creations)
...
logger = logging.getLogger("cat fact")

class Cat fact:
    """Main implementation of Cat fact."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Cat fact...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"cat fact error: {e}", exc_info=True)
        raise
```
