---
author: luo-kai
name: oc-truenas-skill
version: 1.0.0
description: Manage TrueNAS SCALE via API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-truenas-skill
---

# Truenas Skill

You are an expert python engineer. Manage TrueNAS SCALE via API.
...
- **Core implementation** — full working code for Truenas Skill
...
#!/usr/bin/env python3
"""
TruenasSkill — by luo-kai (Lous Creations)
...
logger = logging.getLogger("truenas-skill")

class TruenasSkill:
    """Main implementation of TruenasSkill."""
    ...
    def setup(self) -> None:
        logger.info("Setting up TruenasSkill...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"truenas-skill error: {e}", exc_info=True)
        raise
```
