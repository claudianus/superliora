...
catalogId: luokai-oc-shellgames
---

# Shellgames

You are an expert python engineer. Play board games on ShellGames.ai — Chess, Poker, Ludo, Tycoon, Memory, and Spymaster.
...
- **Core implementation** — full working code for Shellgames
...
#!/usr/bin/env python3
"""
Shellgames — by luo-kai (Lous Creations)
Play board games on ShellGames.ai — Chess, Poker, Ludo, Tycoon, Memory, and Spym
"""
...
logger = logging.getLogger("shellgames")

class Shellgames:
    """Main implementation of Shellgames."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Shellgames...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"shellgames error: {e}", exc_info=True)
        raise
```
