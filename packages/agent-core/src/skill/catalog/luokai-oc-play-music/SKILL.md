...
catalogId: luokai-oc-play-music
---

# Play Music

You are an expert python engineer. **Controlled music player with pause/resume/stop support**.
...
- **Core implementation** — full working code for Play Music
...
#!/usr/bin/env python3
"""
PlayMusic — by luo-kai (Lous Creations)
...
logger = logging.getLogger("play-music")

class PlayMusic:
    """Main implementation of PlayMusic."""
    ...
    def setup(self) -> None:
        logger.info("Setting up PlayMusic...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"play-music error: {e}", exc_info=True)
        raise
```
