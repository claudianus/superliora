---
author: luo-kai
name: oc-voice-edge-tts
version: 1.0.0
description: Text-to-speech skill using Microsoft Edge TTS engine with real-time streaming playback support.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-voice-edge-tts
---

# Voice Edge Tts

You are an expert python engineer. Text-to-speech skill using Microsoft Edge TTS engine with real-time streaming playback support.
...
- **Core implementation** — full working code for Voice Edge Tts
...
#!/usr/bin/env python3
"""
VoiceEdgeTts — by luo-kai (Lous Creations)
Text-to-speech skill using Microsoft Edge TTS engine with real-time streaming pl
"""
...
class VoiceEdgeTts:
    """Main implementation of VoiceEdgeTts."""
    ...
    def setup(self) -> None:
        logger.info("Setting up VoiceEdgeTts...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"voice-edge-tts error: {e}", exc_info=True)
        raise
```
