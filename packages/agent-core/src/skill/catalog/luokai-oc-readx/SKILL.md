...
catalogId: luokai-oc-readx
---

# Readx

You are an expert python engineer. Twitter/X intelligence toolkit: analyze users, tweets, trends, communities, and networks.
...
- **Core implementation** — full working code for Readx
...
#!/usr/bin/env python3
"""
Readx — by luo-kai (Lous Creations)
Twitter/X intelligence toolkit: analyze users, tweets, trends, communities, and 
"""
...
logger = logging.getLogger("readx")

class Readx:
    """Main implementation of Readx."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"readx error: {e}", exc_info=True)
        raise
```
