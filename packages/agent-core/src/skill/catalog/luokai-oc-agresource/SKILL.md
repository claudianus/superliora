...
name: oc-agresource
version: 1.0.0
description: Use this skill to scrape, summarize, and analyze AgResource grain marketing newsletters.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-agresource
---

# Agresource

You are an expert python engineer. Use this skill to scrape, summarize, and analyze AgResource grain marketing newsletters.
...
- **Core implementation** — full working code for Agresource
...
#!/usr/bin/env python3
"""
Agresource — by luo-kai (Lous Creations)
Use this skill to scrape, summarize, and analyze AgResource grain marketing news
"""
...
logger = logging.getLogger("agresource")

class Agresource:
    """Main implementation of Agresource."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Agresource...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"agresource error: {e}", exc_info=True)
        raise
```
