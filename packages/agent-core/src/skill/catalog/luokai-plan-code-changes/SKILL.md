...
catalogId: luokai-plan-code-changes
---
...
Create a plan markdown file within the project folder, prefixed with `plan-` and followed by a slug describing the plan, e.g. `plan-do-something.md`
