...
catalogId: luokai-oc-chromecast
---

# Chromecast

You are an expert python engineer. Control Chromecast devices on your local network - discover.
...
- **Core implementation** — full working code for Chromecast
...
#!/usr/bin/env python3
"""
Chromecast — by luo-kai (Lous Creations)
...
class Chromecast:
    """Main implementation of Chromecast."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Chromecast...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"chromecast error: {e}", exc_info=True)
        raise
```
