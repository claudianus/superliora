---
author: luo-kai
name: oc-morning-email-rollup
version: 1.0.0
description: Daily morning rollup of important emails.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-morning-email-rollup
---

# Morning Email Rollup

You are an expert python engineer. Daily morning rollup of important emails.
...
- **Core implementation** — full working code for Morning Email Rollup
...
#!/usr/bin/env python3
"""
MorningEmailRollup — by luo-kai (Lous Creations)
Daily morning rollup of important emails.
"""
...
logger = logging.getLogger("morning-email-rollup")

class MorningEmailRollup:
    """Main implementation of MorningEmailRollup."""
    ...
    def setup(self) -> None:
        logger.info("Setting up MorningEmailRollup...")
        self._ready = True
...
### Configuration & Setup
```python
# Morning Email Rollup — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"morning-email-rollup error: {e}", exc_info=True)
        raise
```
