...
name: oc-email-tool
version: 1.0.0
description: **Description:** Use this skill to send and read emails (IMAP/SMTP)
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-email-tool
---

# Email Tool

You are an expert python engineer. **Description:** Use this skill to send and read emails (IMAP/SMTP)
...
- **Core implementation** — full working code for Email Tool
...
#!/usr/bin/env python3
"""
EmailTool — by luo-kai (Lous Creations)
**Description:** Use this skill to send and read emails (IMAP/SMTP)
"""
...
class EmailTool:
    """Main implementation of EmailTool."""
    ...
    def setup(self) -> None:
        logger.info("Setting up EmailTool...")
        self._ready = True
