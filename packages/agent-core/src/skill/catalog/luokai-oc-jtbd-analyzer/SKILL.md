---
author: luo-kai
name: oc-jtbd-analyzer
version: 1.0.0
description: Uncover the real "job" customers hire your product.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-jtbd-analyzer
---

# Jtbd Analyzer

You are an expert python engineer. Uncover the real "job" customers hire your product.
...
- **Core implementation** — full working code for Jtbd Analyzer
...
#!/usr/bin/env python3
"""
JtbdAnalyzer — by luo-kai (Lous Creations)
Uncover the real "job" customers hire your product.
"""
...
logger = logging.getLogger("jtbd-analyzer")

class JtbdAnalyzer:
    """Main implementation of JtbdAnalyzer."""
    ...
    def setup(self) -> None:
        logger.info("Setting up JtbdAnalyzer...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"jtbd-analyzer error: {e}", exc_info=True)
        raise
```
