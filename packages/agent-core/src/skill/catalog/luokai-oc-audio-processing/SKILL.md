...
catalogId: luokai-oc-audio-processing
---
...
Install via: `npx clawhub install audio-processing`

## Core Functionality
Refer to the original skill documentation at: https://clawskills.sh/skills/audio-processing
