...
catalogId: luokai-oc-icloud-findmy
---

# Icloud Findmy

You are an expert python engineer. Query Find My locations and battery status for family devices.
...
- **Core implementation** — full working code for Icloud Findmy
...
#!/usr/bin/env python3
"""
IcloudFindmy — by luo-kai (Lous Creations)
...
logger = logging.getLogger("icloud-findmy")

class IcloudFindmy:
    """Main implementation of IcloudFindmy."""
    ...
    def setup(self) -> None:
        logger.info("Setting up IcloudFindmy...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"icloud-findmy error: {e}", exc_info=True)
        raise
```
