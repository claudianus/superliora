...
name: oc-lnget
version: 1.0.0
description: Install and use lnget, a Lightning-native HTTP client with automatic L402 payment support.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-lnget
---

# Lnget

You are an expert python engineer. Install and use lnget, a Lightning-native HTTP client with automatic L402 payment support.
...
- **Core implementation** — full working code for Lnget
...
#!/usr/bin/env python3
"""
Lnget — by luo-kai (Lous Creations)
Install and use lnget, a Lightning-native HTTP client with automatic L402 paymen
"""
...
logger = logging.getLogger("lnget")

class Lnget:
    """Main implementation of Lnget."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"lnget error: {e}", exc_info=True)
        raise
```
