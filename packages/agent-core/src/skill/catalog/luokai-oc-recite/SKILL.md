...
name: oc-recite
version: 1.0.0
description: AI-driven receipt bookkeeping via the Recite Vision API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-recite
---

# Recite

You are an expert python engineer. AI-driven receipt bookkeeping via the Recite Vision API.
...
- **Core implementation** — full working code for Recite
...
#!/usr/bin/env python3
"""
Recite — by luo-kai (Lous Creations)
...
logger = logging.getLogger("recite")

class Recite:
    """Main implementation of Recite."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"recite error: {e}", exc_info=True)
        raise
```
