---
author: luo-kai
name: oc-hle-benchmark-evolver
version: 1.0.0
description: Runs HLE-oriented benchmark reward ingestion and curriculum generation for capability-evolver.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-hle-benchmark-evolver
---

# Hle Benchmark Evolver

You are an expert python engineer. Runs HLE-oriented benchmark reward ingestion and curriculum generation for capability-evolver.
...
- **Core implementation** — full working code for Hle Benchmark Evolver
...
#!/usr/bin/env python3
"""
HleBenchmarkEvolver — by luo-kai (Lous Creations)
Runs HLE-oriented benchmark reward ingestion and curriculum generation for capab
"""
...
logger = logging.getLogger("hle-benchmark-evolver")

class HleBenchmarkEvolver:
    """Main implementation of HleBenchmarkEvolver."""
    ...
    def setup(self) -> None:
        logger.info("Setting up HleBenchmarkEvolver...")
        self._ready = True
...
### Configuration & Setup
```python
# Hle Benchmark Evolver — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"hle-benchmark-evolver error: {e}", exc_info=True)
        raise
```
...
- python-expert
- hle-benchmark-evolver-advanced
