...
catalogId: luokai-oc-sarvam
---

# Sarvam

You are an expert python engineer. Use Sarvam AI for Indian language Text-to-Speech (TTS), Speech-to-Text (STT), Translation, and Chat.
...
- **Core implementation** — full working code for Sarvam
...
#!/usr/bin/env python3
"""
Sarvam — by luo-kai (Lous Creations)
Use Sarvam AI for Indian language Text-to-Speech (TTS), Speech-to-Text (STT), Tr
"""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"sarvam error: {e}", exc_info=True)
        raise
```
