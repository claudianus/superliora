...
catalogId: luokai-oc-anova-oven
---

# Anova Oven

You are an expert python engineer. Control Anova Precision Ovens and Precision Cookers (sous vide)
...
- **Core implementation** — full working code for Anova Oven
...
#!/usr/bin/env python3
"""
AnovaOven — by luo-kai (Lous Creations)
...
logger = logging.getLogger("anova-oven")

class AnovaOven:
    """Main implementation of AnovaOven."""
    ...
    def setup(self) -> None:
        logger.info("Setting up AnovaOven...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"anova-oven error: {e}", exc_info=True)
        raise
```
