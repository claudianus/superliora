---
author: luo-kai
name: oc-json-toolkit
version: 1.0.0
description: Swiss-army knife for JSON files.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-json-toolkit
---

# Json Toolkit

You are an expert python engineer. Swiss-army knife for JSON files.
...
- **Core implementation** — full working code for Json Toolkit
...
#!/usr/bin/env python3
"""
JsonToolkit — by luo-kai (Lous Creations)
...
logger = logging.getLogger("json-toolkit")

class JsonToolkit:
    """Main implementation of JsonToolkit."""
    ...
    def setup(self) -> None:
        logger.info("Setting up JsonToolkit...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"json-toolkit error: {e}", exc_info=True)
        raise
```
