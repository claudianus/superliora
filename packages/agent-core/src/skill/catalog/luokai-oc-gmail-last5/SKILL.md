...
name: oc-gmail-last5
version: 1.0.0
description: summary: "Show the last 5 unique emails in the inbox using gog".
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-gmail-last5
---

# Gmail Last5

You are an expert python engineer. summary: "Show the last 5 unique emails in the inbox using gog".
...
- **Core implementation** — full working code for Gmail Last5
...
#!/usr/bin/env python3
"""
GmailLast5 — by luo-kai (Lous Creations)
...
logger = logging.getLogger("gmail-last5")

class GmailLast5:
    """Main implementation of GmailLast5."""
    ...
    def setup(self) -> None:
        logger.info("Setting up GmailLast5...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"gmail-last5 error: {e}", exc_info=True)
        raise
```
