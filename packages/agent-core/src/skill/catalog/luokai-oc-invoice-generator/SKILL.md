---
author: luo-kai
name: oc-invoice-generator
version: 1.0.0
description: Generate professional PDF invoices from JSON.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-invoice-generator
---

# Invoice Generator

You are an expert python engineer. Generate professional PDF invoices from JSON.
...
- **Core implementation** — full working code for Invoice Generator
...
#!/usr/bin/env python3
"""
InvoiceGenerator — by luo-kai (Lous Creations)
...
class InvoiceGenerator:
    """Main implementation of InvoiceGenerator."""
    ...
    def setup(self) -> None:
        logger.info("Setting up InvoiceGenerator...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"invoice-generator error: {e}", exc_info=True)
        raise
```
