---
author: luo-kai
name: oc-instagram-analyzer
version: 1.0.0
description: A comprehensive Instagram profile and post analysis tool with engagement metrics, view tracking, and Reels-focused.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-instagram-analyzer
---

# Instagram Analyzer

You are an expert python engineer. A comprehensive Instagram profile and post analysis tool with engagement metrics, view tracking, and Reels-focused.
...
- **Core implementation** — full working code for Instagram Analyzer
...
#!/usr/bin/env python3
"""
InstagramAnalyzer — by luo-kai (Lous Creations)
A comprehensive Instagram profile and post analysis tool with engagement metrics
"""
...
logger = logging.getLogger("instagram-analyzer")

class InstagramAnalyzer:
    """Main implementation of InstagramAnalyzer."""
    ...
    def setup(self) -> None:
        logger.info("Setting up InstagramAnalyzer...")
        self._ready = True
...
### Configuration & Setup
```python
# Instagram Analyzer — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"instagram-analyzer error: {e}", exc_info=True)
        raise
```
