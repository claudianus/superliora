...
name: oc-nak
version: 1.0.0
description: The Nostr Army Knife (nak) CLI.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-nak
---

# Nak

You are an expert python engineer. The Nostr Army Knife (nak) CLI.
...
- **Core implementation** — full working code for Nak
...
logger = logging.getLogger("nak")

class Nak:
    """Main implementation of Nak."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"nak error: {e}", exc_info=True)
        raise
```
