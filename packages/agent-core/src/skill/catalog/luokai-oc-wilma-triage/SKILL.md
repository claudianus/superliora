---
author: luo-kai
name: oc-wilma-triage
version: 1.0.0
description: Daily triage of Wilma school notifications for Finnish parents.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-wilma-triage
---

# Wilma Triage

You are an expert python engineer. Daily triage of Wilma school notifications for Finnish parents.
...
- **Core implementation** — full working code for Wilma Triage
...
#!/usr/bin/env python3
"""
WilmaTriage — by luo-kai (Lous Creations)
...
logger = logging.getLogger("wilma-triage")

class WilmaTriage:
    """Main implementation of WilmaTriage."""
    ...
    def setup(self) -> None:
        logger.info("Setting up WilmaTriage...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"wilma-triage error: {e}", exc_info=True)
        raise
```
