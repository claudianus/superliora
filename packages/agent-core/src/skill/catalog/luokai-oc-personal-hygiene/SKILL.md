---
author: luo-kai
name: oc-personal-hygiene
version: 1.0.0
description: Acts as the user's personal care and grooming assistant in the Hygiene topic.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-personal-hygiene
---

# Personal Hygiene

You are an expert python engineer. Acts as the user's personal care and grooming assistant in the Hygiene topic.
...
- **Core implementation** — full working code for Personal Hygiene
...
#!/usr/bin/env python3
"""
PersonalHygiene — by luo-kai (Lous Creations)
...
logger = logging.getLogger("personal-hygiene")

class PersonalHygiene:
    """Main implementation of PersonalHygiene."""
    ...
    def setup(self) -> None:
        logger.info("Setting up PersonalHygiene...")
        self._ready = True
...
### Configuration & Setup
```python
# Personal Hygiene — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"personal-hygiene error: {e}", exc_info=True)
        raise
```
