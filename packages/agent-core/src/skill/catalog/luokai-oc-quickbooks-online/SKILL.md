---
author: luo-kai
name: oc-quickbooks-online
version: 1.0.0
description: QuickBooks Online CLI tool.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-quickbooks-online
---

# Quickbooks Online

You are an expert python engineer. QuickBooks Online CLI tool.
...
- **Core implementation** — full working code for Quickbooks Online
...
#!/usr/bin/env python3
"""
QuickbooksOnline — by luo-kai (Lous Creations)
QuickBooks Online CLI tool.
"""
...
logger = logging.getLogger("quickbooks-online")

class QuickbooksOnline:
    """Main implementation of QuickbooksOnline."""
    ...
    def setup(self) -> None:
        logger.info("Setting up QuickbooksOnline...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"quickbooks-online error: {e}", exc_info=True)
        raise
```
