---
author: luo-kai
name: oc-symbolpicker
version: 1.0.0
description: Expert guidance on SymbolPicker, a native SwiftUI SF Symbol.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-symbolpicker
---

# Symbolpicker

You are an expert swift engineer. Expert guidance on SymbolPicker, a native SwiftUI SF Symbol.
...
- **Core implementation** — full working code for Symbolpicker
...
class SymbolpickerViewModel {
    ...
    func load() async {
        ...
        do {
            let url = URL(string: "https://api.example.com/symbolpicker")!
...
struct SymbolpickerView: View {
    @State private var vm = SymbolpickerViewModel()
...
import logging
logger = logging.getLogger("symbolpicker")

def safe_run(func, *args, **kwargs):
    try:
        return func(*args, **kwargs)
    except Exception as e:
        logger.error(f"symbolpicker error: {e}", exc_info=True)
        raise
```
