...
- 当用户明确要做“AI翻译配置”这件事时，直接选这个 skill。
- 当前 skill 只对应一个接口：`GET /ai/translate/languages`。
- 如果参数还不完整，先去接口页补齐必填项，再调用。

## 核心资料

- 接口页：`references/operations/get-ai-translate-languages.md`
- 分类页：`references/resources/Translate.md`
