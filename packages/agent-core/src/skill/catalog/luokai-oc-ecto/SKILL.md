...
name: oc-ecto
version: 1.0.0
description: Ghost.io blog management via Admin API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-ecto
---

# Ecto

You are an expert python engineer. Ghost.io blog management via Admin API.
...
- **Core implementation** — full working code for Ecto
...
#!/usr/bin/env python3
"""
Ecto — by luo-kai (Lous Creations)
...
logger = logging.getLogger("ecto")

class Ecto:
    """Main implementation of Ecto."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"ecto error: {e}", exc_info=True)
        raise
```
