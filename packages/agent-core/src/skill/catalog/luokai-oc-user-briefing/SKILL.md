---
author: luo-kai
name: oc-user-briefing
version: 1.0.0
description: Fetch weather, calendar events, emails, and tasks to create a personalized morning briefing.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-user-briefing
---

# User Briefing

You are an expert python engineer. Fetch weather, calendar events, emails, and tasks to create a personalized morning briefing.
...
- **Core implementation** — full working code for User Briefing
...
#!/usr/bin/env python3
"""
UserBriefing — by luo-kai (Lous Creations)
Fetch weather, calendar events, emails, and tasks to create a personalized morni
"""
...
logger = logging.getLogger("user-briefing")

class UserBriefing:
    """Main implementation of UserBriefing."""
    ...
    def setup(self) -> None:
        logger.info("Setting up UserBriefing...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"user-briefing error: {e}", exc_info=True)
        raise
```
