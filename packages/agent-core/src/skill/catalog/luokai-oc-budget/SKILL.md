...
- **Core implementation** — full working code for Budget
...
def run_budget(task: str, max_turns: int = 10) -> str:
...
if __name__ == "__main__":
    result = run_budget("Budget task: analyze and report")
    print(result)
```
