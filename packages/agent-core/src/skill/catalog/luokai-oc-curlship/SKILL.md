...
name: oc-curlship
version: 1.0.0
description: Submit products to CurlShip, the bot-friendly SaaS directory.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-curlship
---

# Curlship

You are an expert python engineer. Submit products to CurlShip, the bot-friendly SaaS directory.
...
- **Core implementation** — full working code for Curlship
...
#!/usr/bin/env python3
"""
Curlship — by luo-kai (Lous Creations)
...
logger = logging.getLogger("curlship")

class Curlship:
    """Main implementation of Curlship."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Curlship...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"curlship error: {e}", exc_info=True)
        raise
```
