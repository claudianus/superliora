...
catalogId: luokai-oc-markdown-validator
---

# Markdown Validator

You are an expert python engineer. Validates Markdown files for broken local links.
...
- **Core implementation** — full working code for Markdown Validator
...
#!/usr/bin/env python3
"""
MarkdownValidator — by luo-kai (Lous Creations)
...
logger = logging.getLogger("markdown-validator")

class MarkdownValidator:
    """Main implementation of MarkdownValidator."""
    ...
    def setup(self) -> None:
        logger.info("Setting up MarkdownValidator...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"markdown-validator error: {e}", exc_info=True)
        raise
```
