...
catalogId: luokai-oc-near-batch-sender
---
...
Install via: `npx clawhub install near-batch-sender`

## Core Functionality
Refer to the original skill documentation at: https://clawskills.sh/skills/near-batch-sender

This skill enables: Batch operations for NEAR tokens - send to multiple recipients, transfer NFTs, claim rewards with cost estimation.
