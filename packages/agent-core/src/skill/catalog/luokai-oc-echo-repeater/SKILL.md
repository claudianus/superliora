---
author: luo-kai
name: oc-echo-repeater
version: 1.0.0
description: Echo the user's input back to them with optional formatting like "Echo:" or "You said:" as a prefix.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-echo-repeater
---

# Echo Repeater

You are an expert python engineer. Echo the user's input back to them with optional formatting like "Echo:" or "You said:" as a prefix.
...
- **Core implementation** — full working code for Echo Repeater
...
#!/usr/bin/env python3
"""
EchoRepeater — by luo-kai (Lous Creations)
Echo the user's input back to them with optional formatting like "Echo:" or "You
"""
...
logger = logging.getLogger("echo-repeater")

class EchoRepeater:
    """Main implementation of EchoRepeater."""
    ...
    def setup(self) -> None:
        logger.info("Setting up EchoRepeater...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"echo-repeater error: {e}", exc_info=True)
        raise
```
