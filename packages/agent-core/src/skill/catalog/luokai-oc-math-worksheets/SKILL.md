---
author: luo-kai
name: oc-math-worksheets
version: 1.0.0
description: Generate professional math practice worksheets and full answer keys as PDFs.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-math-worksheets
---

# Math Worksheets

You are an expert python engineer. Generate professional math practice worksheets and full answer keys as PDFs.
...
- **Core implementation** — full working code for Math Worksheets
...
#!/usr/bin/env python3
"""
MathWorksheets — by luo-kai (Lous Creations)
...
logger = logging.getLogger("math-worksheets")

class MathWorksheets:
    """Main implementation of MathWorksheets."""
    ...
    def setup(self) -> None:
        logger.info("Setting up MathWorksheets...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"math-worksheets error: {e}", exc_info=True)
        raise
```
