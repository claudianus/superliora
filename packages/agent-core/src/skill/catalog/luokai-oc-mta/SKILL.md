...
name: oc-mta
version: 1.0.0
description: NYC MTA transit — real-time subway arrivals, bus predictions, service alerts, and route info for the New York City.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-mta
---

# Mta

You are an expert python engineer. NYC MTA transit — real-time subway arrivals, bus predictions, service alerts, and route info for the New York City.
...
- **Core implementation** — full working code for Mta
...
#!/usr/bin/env python3
"""
Mta — by luo-kai (Lous Creations)
NYC MTA transit — real-time subway arrivals, bus predictions, service alerts, an
"""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"mta error: {e}", exc_info=True)
        raise
```
