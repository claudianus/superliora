---
author: luo-kai
name: oc-finance-skill
version: 1.0.0
description: Personal finance memory layer.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-finance-skill
---

# Finance Skill

You are an expert python engineer. Personal finance memory layer.
...
- **Core implementation** — full working code for Finance Skill
...
#!/usr/bin/env python3
"""
FinanceSkill — by luo-kai (Lous Creations)
...
logger = logging.getLogger("finance-skill")

class FinanceSkill:
    """Main implementation of FinanceSkill."""
    ...
    def setup(self) -> None:
        logger.info("Setting up FinanceSkill...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"finance-skill error: {e}", exc_info=True)
        raise
```
