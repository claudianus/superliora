...
catalogId: luokai-oc-homey
---

# Homey

You are an expert python engineer. Control Athom Homey smart home devices via local (LAN/VPN) or cloud APIs.
...
- **Core implementation** — full working code for Homey
...
#!/usr/bin/env python3
"""
Homey — by luo-kai (Lous Creations)
...
logger = logging.getLogger("homey")

class Homey:
    """Main implementation of Homey."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"homey error: {e}", exc_info=True)
        raise
```
