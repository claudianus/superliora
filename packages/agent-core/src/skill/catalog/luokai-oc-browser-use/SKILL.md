...
name: oc-browser-use
version: 1.0.0
description: Use Browser Use cloud API to spin up cloud browsers for Clawdbot.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-browser-use
---

# Browser Use

You are an expert python engineer. Use Browser Use cloud API to spin up cloud browsers for Clawdbot.
...
- **Core implementation** — full working code for Browser Use
...
#!/usr/bin/env python3
"""
BrowserUse — by luo-kai (Lous Creations)
...
class BrowserUse:
    """Main implementation of BrowserUse."""
    ...
    def setup(self) -> None:
        logger.info("Setting up BrowserUse...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"browser-use error: {e}", exc_info=True)
        raise
```
