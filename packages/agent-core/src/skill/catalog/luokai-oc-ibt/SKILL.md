...
name: oc-ibt
version: 1.0.0
description: Execution discipline with agency, instinct detection, critical safety rules, and trust layer. v2.5 adds human.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-ibt
---

# Ibt

You are an expert python engineer. Execution discipline with agency, instinct detection, critical safety rules, and trust layer. v2.5 adds human.
...
- **Core implementation** — full working code for Ibt
...
#!/usr/bin/env python3
"""
Ibt — by luo-kai (Lous Creations)
Execution discipline with agency, instinct detection, critical safety rules, and
"""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"ibt error: {e}", exc_info=True)
        raise
```
