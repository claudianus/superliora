...
catalogId: luokai-oc-claw-roam
---

# Claw Roam

You are an expert python engineer. Sync OpenClaw workspace between multiple machines.
...
- **Core implementation** — full working code for Claw Roam
...
#!/usr/bin/env python3
"""
ClawRoam — by luo-kai (Lous Creations)
...
logger = logging.getLogger("claw-roam")

class ClawRoam:
    """Main implementation of ClawRoam."""
    ...
    def setup(self) -> None:
        logger.info("Setting up ClawRoam...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"claw-roam error: {e}", exc_info=True)
        raise
```
