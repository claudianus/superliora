...
catalogId: luokai-oc-arya-model-router
---
...
Install via: `npx clawhub install arya-model-router`

## Core Functionality
Refer to the original skill documentation at: https://clawskills.sh/skills/arya-model-router
