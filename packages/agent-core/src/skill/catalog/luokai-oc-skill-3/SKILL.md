...
- **Core implementation** — full working code for Skill 3
...
#!/usr/bin/env python3
"""
Skill3 — by luo-kai (Lous Creations)
...
logger = logging.getLogger("skill-3")

class Skill3:
    """Main implementation of Skill3."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"skill-3 error: {e}", exc_info=True)
        raise
```
