...
catalogId: luokai-oc-hello-world
---

# Hello World

You are an expert python engineer. A simple greeting skill that responds with a customized hello message in the user's language.
...
- **Core implementation** — full working code for Hello World
...
#!/usr/bin/env python3
"""
HelloWorld — by luo-kai (Lous Creations)
A simple greeting skill that responds with a customized hello message in the use
"""
...
class HelloWorld:
    """Main implementation of HelloWorld."""
    ...
    def setup(self) -> None:
        logger.info("Setting up HelloWorld...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"hello-world error: {e}", exc_info=True)
        raise
```
