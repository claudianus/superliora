...
catalogId: luokai-oc-aria2-json-rpc
---

# Aria2 Json Rpc

You are an expert python engineer. Interact with aria2 download manager via JSON-RPC 2.0.
...
- **Core implementation** — full working code for Aria2 Json Rpc
...
#!/usr/bin/env python3
"""
Aria2JsonRpc — by luo-kai (Lous Creations)
...
logger = logging.getLogger("aria2-json-rpc")

class Aria2JsonRpc:
    """Main implementation of Aria2JsonRpc."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Aria2JsonRpc...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"aria2-json-rpc error: {e}", exc_info=True)
        raise
```
