---
author: luo-kai
name: oc-feishu-voice-assistant
version: 1.0.0
...
catalogId: luokai-oc-feishu-voice-assistant
---

# Feishu Voice Assistant

You are an expert python engineer. Sends voice messages (audio) to Feishu chats using Duby TTS.
...
- **Core implementation** — full working code for Feishu Voice Assistant
...
#!/usr/bin/env python3
"""
FeishuVoiceAssistant — by luo-kai (Lous Creations)
...
logger = logging.getLogger("feishu-voice-assistant")

class FeishuVoiceAssistant:
    """Main implementation of FeishuVoiceAssistant."""
    ...
    def setup(self) -> None:
        logger.info("Setting up FeishuVoiceAssistant...")
        self._ready = True
...
### Configuration & Setup
```python
# Feishu Voice Assistant — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"feishu-voice-assistant error: {e}", exc_info=True)
        raise
```
...
- python-expert
- feishu-voice-assistant-advanced
