...
name: oc-cast
version: 1.0.0
description: Skill for managing EVM wallets, transactions, and network helpers via cast; covers onboarding, checks.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-cast
---

# Cast

You are an expert python engineer. Skill for managing EVM wallets, transactions, and network helpers via cast; covers onboarding, checks.
...
- **Core implementation** — full working code for Cast
...
#!/usr/bin/env python3
"""
Cast — by luo-kai (Lous Creations)
Skill for managing EVM wallets, transactions, and network helpers via cast; cove
"""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"cast error: {e}", exc_info=True)
        raise
```
