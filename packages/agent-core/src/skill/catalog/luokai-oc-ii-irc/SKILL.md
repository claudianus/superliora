...
name: oc-ii-irc
version: 1.0.0
description: Persistent IRC presence using ii (minimalist file-based IRC client)
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-ii-irc
---

# Ii Irc

You are an expert python engineer. Persistent IRC presence using ii (minimalist file-based IRC client)
...
- **Core implementation** — full working code for Ii Irc
...
#!/usr/bin/env python3
"""
IiIrc — by luo-kai (Lous Creations)
...
logger = logging.getLogger("ii-irc")

class IiIrc:
    """Main implementation of IiIrc."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"ii-irc error: {e}", exc_info=True)
        raise
```
