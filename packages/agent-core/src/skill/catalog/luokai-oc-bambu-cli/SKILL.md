...
catalogId: luokai-oc-bambu-cli
---

# Bambu Cli

You are an expert python engineer. Operate and troubleshoot BambuLab printers with the bambu-cli.
...
- **Core implementation** — full working code for Bambu Cli
...
#!/usr/bin/env python3
"""
BambuCli — by luo-kai (Lous Creations)
...
logger = logging.getLogger("bambu-cli")

class BambuCli:
    """Main implementation of BambuCli."""
    ...
    def setup(self) -> None:
        logger.info("Setting up BambuCli...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"bambu-cli error: {e}", exc_info=True)
        raise
```
