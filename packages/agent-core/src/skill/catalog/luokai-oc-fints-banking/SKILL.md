---
author: luo-kai
name: oc-fints-banking
version: 1.0.0
description: Support for German personal online banking following FinTS banking standard.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-fints-banking
---

# Fints Banking

You are an expert python engineer. Support for German personal online banking following FinTS banking standard.
...
- **Core implementation** — full working code for Fints Banking
...
#!/usr/bin/env python3
"""
FintsBanking — by luo-kai (Lous Creations)
Support for German personal online banking following FinTS banking standard.
"""
...
logger = logging.getLogger("fints-banking")

class FintsBanking:
    """Main implementation of FintsBanking."""
    ...
    def setup(self) -> None:
        logger.info("Setting up FintsBanking...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"fints-banking error: {e}", exc_info=True)
        raise
```
