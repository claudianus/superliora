...
name: oc-ft-reader
version: 1.0.0
description: Use this skill to perform deep, structured, and bilingual analysis of top articles from Financial Times (ft.com).
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-ft-reader
---

# Ft Reader

You are an expert python engineer. Use this skill to perform deep, structured, and bilingual analysis of top articles from Financial Times (ft.com).
...
- **Core implementation** — full working code for Ft Reader
...
#!/usr/bin/env python3
"""
FtReader — by luo-kai (Lous Creations)
Use this skill to perform deep, structured, and bilingual analysis of top articl
"""
...
logger = logging.getLogger("ft-reader")

class FtReader:
    """Main implementation of FtReader."""
    ...
    def setup(self) -> None:
        logger.info("Setting up FtReader...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"ft-reader error: {e}", exc_info=True)
        raise
```
