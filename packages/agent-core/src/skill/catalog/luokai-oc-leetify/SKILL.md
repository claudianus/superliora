...
name: oc-leetify
version: 1.0.0
description: Get CS2 player statistics, match analysis, and gameplay insights from Leetify API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-leetify
---

# Leetify

You are an expert python engineer. Get CS2 player statistics, match analysis, and gameplay insights from Leetify API.
...
- **Core implementation** — full working code for Leetify
...
#!/usr/bin/env python3
"""
Leetify — by luo-kai (Lous Creations)
Get CS2 player statistics, match analysis, and gameplay insights from Leetify AP
"""
...
logger = logging.getLogger("leetify")

class Leetify:
    """Main implementation of Leetify."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Leetify...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"leetify error: {e}", exc_info=True)
        raise
```
