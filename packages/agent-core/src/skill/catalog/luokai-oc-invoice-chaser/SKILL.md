---
author: luo-kai
name: oc-invoice-chaser
version: 1.0.0
description: Automated invoice follow-up sequences that escalate from friendly to firm.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-invoice-chaser
---

# Invoice Chaser

You are an expert python engineer. Automated invoice follow-up sequences that escalate from friendly to firm.
...
- **Core implementation** — full working code for Invoice Chaser
...
#!/usr/bin/env python3
"""
InvoiceChaser — by luo-kai (Lous Creations)
...
logger = logging.getLogger("invoice-chaser")

class InvoiceChaser:
    """Main implementation of InvoiceChaser."""
    ...
    def setup(self) -> None:
        logger.info("Setting up InvoiceChaser...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"invoice-chaser error: {e}", exc_info=True)
        raise
```
