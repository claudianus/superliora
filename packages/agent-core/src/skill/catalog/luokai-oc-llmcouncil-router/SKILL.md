...
catalogId: luokai-oc-llmcouncil-router
---
...
Install via: `npx clawhub install llmcouncil-router`

## Core Functionality
Refer to the original skill documentation at: https://clawskills.sh/skills/llmcouncil-router

This skill enables: Route any prompt to the best-performing LLM using peer-reviewed council rankings from LLM Council.
