...
catalogId: luokai-oc-blucli
---

# Blucli

You are an expert python engineer. BluOS CLI (blu) for discovery, playback, grouping.
...
- **Core implementation** — full working code for Blucli
...
#!/usr/bin/env python3
"""
Blucli — by luo-kai (Lous Creations)
...
logger = logging.getLogger("blucli")

class Blucli:
    """Main implementation of Blucli."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"blucli error: {e}", exc_info=True)
        raise
```
