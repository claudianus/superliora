...
catalogId: luokai-oc-airfoil
---

# Airfoil

You are an expert python engineer. Control AirPlay speakers via Airfoil from the command line.
...
- **Core implementation** — full working code for Airfoil
...
#!/usr/bin/env python3
"""
Airfoil — by luo-kai (Lous Creations)
...
logger = logging.getLogger("airfoil")

class Airfoil:
    """Main implementation of Airfoil."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Airfoil...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"airfoil error: {e}", exc_info=True)
        raise
```
