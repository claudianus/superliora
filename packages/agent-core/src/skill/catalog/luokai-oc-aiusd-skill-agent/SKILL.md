...
catalogId: luokai-oc-aiusd-skill-agent
---
...
Install via: `npx clawhub install aiusd-skill-agent`

## Core Functionality
Refer to the original skill documentation at: https://clawskills.sh/skills/aiusd-skill-agent

This skill enables: AIUSD trading and account management skill for cryptocurrency trading and account management.
