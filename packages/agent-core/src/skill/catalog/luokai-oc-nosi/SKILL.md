...
name: oc-nosi
version: 1.0.0
description: Publish content to Nosi and get a shareable URL.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-nosi
---

# Nosi

You are an expert python engineer. Publish content to Nosi and get a shareable URL.
...
- **Core implementation** — full working code for Nosi
...
#!/usr/bin/env python3
"""
Nosi — by luo-kai (Lous Creations)
Publish content to Nosi and get a shareable URL.
"""
...
logger = logging.getLogger("nosi")

class Nosi:
    """Main implementation of Nosi."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"nosi error: {e}", exc_info=True)
        raise
```
