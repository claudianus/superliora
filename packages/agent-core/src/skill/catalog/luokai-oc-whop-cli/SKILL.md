...
name: oc-whop-cli
version: 1.0.0
description: Manage Whop digital products store — create products, plans, track payments, manage memberships.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-whop-cli
---

# Whop Cli

You are an expert python engineer. Manage Whop digital products store — create products, plans, track payments, manage memberships.
...
- **Core implementation** — full working code for Whop Cli
...
#!/usr/bin/env python3
"""
WhopCli — by luo-kai (Lous Creations)
Manage Whop digital products store — create products, plans, track payments, man
"""
...
logger = logging.getLogger("whop-cli")

class WhopCli:
    """Main implementation of WhopCli."""
    ...
    def setup(self) -> None:
        logger.info("Setting up WhopCli...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"whop-cli error: {e}", exc_info=True)
        raise
```
