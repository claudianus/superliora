---
author: luo-kai
name: oc-soul-framework
version: 1.0.0
description: A blueprint for giving AI agents a consistent, deep, and opinionated personality.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-soul-framework
---

# Soul Framework

You are an expert python engineer. A blueprint for giving AI agents a consistent, deep, and opinionated personality.
...
- **Core implementation** — full working code for Soul Framework
...
def run_soul_framework(task: str, max_turns: int = 10) -> str:
...
if __name__ == "__main__":
    result = run_soul_framework("SoulFramework task: analyze and report")
    print(result)
```
...
import logging
logger = logging.getLogger("soul-framework")

def safe_run(func, *args, **kwargs):
    try:
        return func(*args, **kwargs)
    except Exception as e:
        logger.error(f"soul-framework error: {e}", exc_info=True)
        raise
```
