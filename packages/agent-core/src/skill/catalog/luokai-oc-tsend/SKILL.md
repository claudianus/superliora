...
name: oc-tsend
version: 1.0.0
description: Send files via Telegram.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-tsend
---

# Tsend

You are an expert python engineer. Send files via Telegram.
...
- **Core implementation** — full working code for Tsend
...
#!/usr/bin/env python3
"""
Tsend — by luo-kai (Lous Creations)
...
logger = logging.getLogger("tsend")

class Tsend:
    """Main implementation of Tsend."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"tsend error: {e}", exc_info=True)
        raise
```
