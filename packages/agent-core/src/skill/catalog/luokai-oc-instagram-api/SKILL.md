---
author: luo-kai
name: oc-instagram-api
version: 1.0.0
description: Post to Instagram (Feed, Story, Reels, Carousel) and Threads using the official Meta Graph API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-instagram-api
---

# Instagram Api

You are an expert python engineer. Post to Instagram (Feed, Story, Reels, Carousel) and Threads using the official Meta Graph API.
...
- **Core implementation** — full working code for Instagram Api
...
#!/usr/bin/env python3
"""
InstagramApi — by luo-kai (Lous Creations)
Post to Instagram (Feed, Story, Reels, Carousel) and Threads using the official 
"""
...
class InstagramApi:
    """Main implementation of InstagramApi."""
    ...
    def setup(self) -> None:
        logger.info("Setting up InstagramApi...")
        self._ready = True
