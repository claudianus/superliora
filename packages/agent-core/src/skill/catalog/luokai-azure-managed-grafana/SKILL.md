...
catalogId: luokai-azure-managed-grafana
---
...
| Topic | URL |
|-------|-----|
| Configure Azure Managed Grafana AMG-MCP server access | https://learn.microsoft.com/en-us/azure/managed-grafana/grafana-mcp-server |
