---
author: luo-kai
name: oc-market-pulse
version: 1.0.0
description: Use when user asks about crypto prices, DeFi yields, market sentiment, fear and greed index, stock prices, upcoming.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-market-pulse
---

# Market Pulse

You are an expert python engineer. Use when user asks about crypto prices, DeFi yields, market sentiment, fear and greed index, stock prices, upcoming.
...
- **Core implementation** — full working code for Market Pulse
...
#!/usr/bin/env python3
"""
MarketPulse — by luo-kai (Lous Creations)
Use when user asks about crypto prices, DeFi yields, market sentiment, fear and 
"""
...
class MarketPulse:
    """Main implementation of MarketPulse."""
    ...
    def setup(self) -> None:
        logger.info("Setting up MarketPulse...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"market-pulse error: {e}", exc_info=True)
        raise
```
