...
catalogId: luokai-oc-bahn
---

# Bahn

You are an expert python engineer. Search Deutsche Bahn train connections using the bahn-cli tool.
...
- **Core implementation** — full working code for Bahn
...
#!/usr/bin/env python3
"""
Bahn — by luo-kai (Lous Creations)
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"bahn error: {e}", exc_info=True)
        raise
```
