---
author: luo-kai
name: oc-wherecaniwatch
version: 1.0.0
description: Find where to stream any movie or TV show in the US using the WhereCanIWatch.tv API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-wherecaniwatch
---

# Wherecaniwatch

You are an expert python engineer. Find where to stream any movie or TV show in the US using the WhereCanIWatch.tv API.
...
- **Core implementation** — full working code for Wherecaniwatch
...
#!/usr/bin/env python3
"""
Wherecaniwatch — by luo-kai (Lous Creations)
Find where to stream any movie or TV show in the US using the WhereCanIWatch.tv 
"""
...
logger = logging.getLogger("wherecaniwatch")

class Wherecaniwatch:
    """Main implementation of Wherecaniwatch."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Wherecaniwatch...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"wherecaniwatch error: {e}", exc_info=True)
        raise
```
