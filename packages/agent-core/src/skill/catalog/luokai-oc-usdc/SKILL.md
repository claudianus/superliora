...
author: luo-kai
tags: [usdc, openclaw, community]
source: https://clawskills.sh/skills/usdc
catalogSource: luokai
catalogId: luokai-oc-usdc
---
...
## Usage
Install via: `npx clawhub install usdc`
Documentation: https://clawskills.sh/skills/usdc
