...
name: oc-windsensei
version: 1.0.0
description: Check wind and weather conditions for wind sports (kitesurfing, wingfoiling, surfing)
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-windsensei
---

# Windsensei

You are an expert python engineer. Check wind and weather conditions for wind sports (kitesurfing, wingfoiling, surfing)
...
- **Core implementation** — full working code for Windsensei
...
#!/usr/bin/env python3
"""
Windsensei — by luo-kai (Lous Creations)
Check wind and weather conditions for wind sports (kitesurfing, wingfoiling, sur
"""
...
logger = logging.getLogger("windsensei")

class Windsensei:
    """Main implementation of Windsensei."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Windsensei...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"windsensei error: {e}", exc_info=True)
        raise
```
