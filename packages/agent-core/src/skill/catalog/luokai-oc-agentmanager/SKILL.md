---
author: luo-kai
name: oc-agentmanager
version: 1.0.0
description: This file is a concise integration contract for AI tool callers and gateway implementers.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-agentmanager
---

# Agentmanager

You are an expert python engineer. This file is a concise integration contract for AI tool callers and gateway implementers.
...
- **Core implementation** — full working code for Agentmanager
...
def run_agentmanager(task: str, max_turns: int = 10) -> str:
...
if __name__ == "__main__":
    result = run_agentmanager("Agentmanager task: analyze and report")
    print(result)
```
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"agentmanager error: {e}", exc_info=True)
        raise
```
