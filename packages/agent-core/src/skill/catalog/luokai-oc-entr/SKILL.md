...
catalogId: luokai-oc-entr
---

# Entr

You are an expert python engineer. Run arbitrary commands when files change.
...
- **Core implementation** — full working code for Entr
...
#!/usr/bin/env python3
"""
Entr — by luo-kai (Lous Creations)
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"entr error: {e}", exc_info=True)
        raise
```
