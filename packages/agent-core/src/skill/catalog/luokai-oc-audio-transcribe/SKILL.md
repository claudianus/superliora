...
catalogId: luokai-oc-audio-transcribe
---

# Audio Transcribe

You are an expert python engineer. Auto-transcribe voice messages using faster-whisper (local, no API key needed).
...
- **Core implementation** — full working code for Audio Transcribe
...
#!/usr/bin/env python3
"""
AudioTranscribe — by luo-kai (Lous Creations)
...
logger = logging.getLogger("audio-transcribe")

class AudioTranscribe:
    """Main implementation of AudioTranscribe."""
    ...
    def setup(self) -> None:
        logger.info("Setting up AudioTranscribe...")
        self._ready = True
...
### Configuration & Setup
```python
# Audio Transcribe — Configuration
