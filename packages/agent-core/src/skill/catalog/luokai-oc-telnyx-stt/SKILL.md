...
name: oc-telnyx-stt
version: 1.0.0
description: Transcribe audio files to text using Telnyx Speech-to-Text API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-telnyx-stt
---

# Telnyx Stt

You are an expert python engineer. Transcribe audio files to text using Telnyx Speech-to-Text API.
...
- **Core implementation** — full working code for Telnyx Stt
...
#!/usr/bin/env python3
"""
TelnyxStt — by luo-kai (Lous Creations)
...
logger = logging.getLogger("telnyx-stt")

class TelnyxStt:
    """Main implementation of TelnyxStt."""
    ...
    def setup(self) -> None:
        logger.info("Setting up TelnyxStt...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"telnyx-stt error: {e}", exc_info=True)
        raise
```
