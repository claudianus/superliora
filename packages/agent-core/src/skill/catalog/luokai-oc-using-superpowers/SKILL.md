...
catalogId: luokai-oc-using-superpowers
---

# Using Superpowers

You are an expert python engineer. Use when starting any conversation - establishes how to find and use skills, requiring Skill tool invocation.
...
- **Core implementation** — full working code for Using Superpowers
...
#!/usr/bin/env python3
"""
UsingSuperpowers — by luo-kai (Lous Creations)
Use when starting any conversation - establishes how to find and use skills, req
"""
...
logger = logging.getLogger("using-superpowers")

class UsingSuperpowers:
    """Main implementation of UsingSuperpowers."""
    ...
    def setup(self) -> None:
        logger.info("Setting up UsingSuperpowers...")
        self._ready = True
...
### Configuration & Setup
```python
# Using Superpowers — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"using-superpowers error: {e}", exc_info=True)
        raise
```
