...
catalogId: luokai-oc-ez-google
---

# Ez Google

You are an expert python engineer. Use when asked to send email, check inbox, read emails, check calendar,.
...
- **Core implementation** — full working code for Ez Google
...
#!/usr/bin/env python3
"""
EzGoogle — by luo-kai (Lous Creations)
...
logger = logging.getLogger("ez-google")

class EzGoogle:
    """Main implementation of EzGoogle."""
    ...
    def setup(self) -> None:
        logger.info("Setting up EzGoogle...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"ez-google error: {e}", exc_info=True)
        raise
```
