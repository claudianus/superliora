---
author: luo-kai
name: oc-ub2-smart-file-organizer
version: 1.0.0
description: A skill that enables Claw to scan a directory, categorize files by type and content, and reorganize them.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-ub2-smart-file-organizer
---

# Ub2 Smart File Organizer

You are an expert python engineer. A skill that enables Claw to scan a directory, categorize files by type and content, and reorganize them.
...
- **Core implementation** — full working code for Ub2 Smart File Organizer
...
#!/usr/bin/env python3
"""
Ub2SmartFileOrganizer — by luo-kai (Lous Creations)
A skill that enables Claw to scan a directory, categorize files by type and cont
"""
...
logger = logging.getLogger("ub2-smart-file-organizer")

class Ub2SmartFileOrganizer:
    """Main implementation of Ub2SmartFileOrganizer."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Ub2SmartFileOrganizer...")
        self._ready = True
...
### Configuration & Setup
```python
# Ub2 Smart File Organizer — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"ub2-smart-file-organizer error: {e}", exc_info=True)
        raise
```
...
- python-expert
- ub2-smart-file-organizer-advanced
