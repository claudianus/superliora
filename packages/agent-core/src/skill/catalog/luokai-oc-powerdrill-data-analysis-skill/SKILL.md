---
author: luo-kai
name: oc-powerdrill-data-analysis-skill
version: 1.0.0
description: This skill should be used when the user wants to analyze, explore, visualize, or query data using Powerdrill.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-powerdrill-data-analysis-skill
---

# Powerdrill Data Analysis Skill

You are an expert python engineer. This skill should be used when the user wants to analyze, explore, visualize, or query data using Powerdrill.
...
- **Core implementation** — full working code for Powerdrill Data Analysis Skill
...
logger = logging.getLogger("powerdrill-data-analysis-skill")
...
def run_powerdrill_data_analysis_skill(source: str, dest: str) -> dict:
    raw = extract(source)
    clean = transform(raw)
    load(clean, dest)
...
### Configuration & Setup
```python
# Powerdrill Data Analysis Skill — Configuration
# Author: luo-kai (Lous Creations)

config = {
    "name": "powerdrill-data-analysis-skill",
    "version": "1.0.0",
    "author": "luo-kai",
    "enabled": True,
    "debug": False,
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"powerdrill-data-analysis-skill error: {e}", exc_info=True)
        raise
```
...
- python-expert
- powerdrill-data-analysis-skill-advanced
