---
author: luo-kai
name: oc-apple-health-skill
version: 1.0.0
description: Talk to your Apple Health data — ask questions about your workouts, heart rate, activity rings, and fitness trends.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-apple-health-skill
---

# Apple Health Skill

You are an expert python engineer. Talk to your Apple Health data — ask questions about your workouts, heart rate, activity rings, and fitness trends.
...
- **Core implementation** — full working code for Apple Health Skill
...
logger = logging.getLogger("apple-health-skill")
...
def run_apple_health_skill(source: str, dest: str) -> dict:
    raw = extract(source)
    clean = transform(raw)
    load(clean, dest)
...
### Configuration & Setup
```python
# Apple Health Skill — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"apple-health-skill error: {e}", exc_info=True)
        raise
```
