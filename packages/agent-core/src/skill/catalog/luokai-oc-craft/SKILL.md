...
name: oc-craft
version: 1.0.0
description: Manage Craft notes, documents.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-craft
---

# Craft

You are an expert python engineer. Manage Craft notes, documents.
...
- **Core implementation** — full working code for Craft
...
#!/usr/bin/env python3
"""
Craft — by luo-kai (Lous Creations)
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"craft error: {e}", exc_info=True)
        raise
```
