---
author: luo-kai
name: oc-mm-easy-voice
version: 1.0.0
description: Simple text-to-speech skill using MiniMax Voice API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-mm-easy-voice
---

# Mm Easy Voice

You are an expert python engineer. Simple text-to-speech skill using MiniMax Voice API.
...
- **Core implementation** — full working code for Mm Easy Voice
...
#!/usr/bin/env python3
"""
MmEasyVoice — by luo-kai (Lous Creations)
Simple text-to-speech skill using MiniMax Voice API.
"""
...
logger = logging.getLogger("mm-easy-voice")

class MmEasyVoice:
    """Main implementation of MmEasyVoice."""
    ...
    def setup(self) -> None:
        logger.info("Setting up MmEasyVoice...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"mm-easy-voice error: {e}", exc_info=True)
        raise
```
