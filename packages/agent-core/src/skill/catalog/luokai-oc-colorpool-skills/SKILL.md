...
catalogId: luokai-oc-colorpool-skills
---
...
Install via: `npx clawhub install colorpool-skills`

## Core Functionality
Refer to the original skill documentation at: https://clawskills.sh/skills/colorpool-skills

This skill enables: ColorPool DEX — Chromia's decentralized exchange for token swaps, liquidity pools, and balance management.
