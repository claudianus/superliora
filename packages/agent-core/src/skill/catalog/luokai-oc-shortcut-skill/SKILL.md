---
author: luo-kai
name: oc-shortcut-skill
version: 1.0.0
description: Access and manage Shortcut.com (formerly Clubhouse) project management.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-shortcut-skill
---

# Shortcut Skill

You are an expert python engineer. Access and manage Shortcut.com (formerly Clubhouse) project management.
...
- **Core implementation** — full working code for Shortcut Skill
...
#!/usr/bin/env python3
"""
ShortcutSkill — by luo-kai (Lous Creations)
Access and manage Shortcut.com (formerly Clubhouse) project management.
"""
...
logger = logging.getLogger("shortcut-skill")

class ShortcutSkill:
    """Main implementation of ShortcutSkill."""
    ...
    def setup(self) -> None:
        logger.info("Setting up ShortcutSkill...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"shortcut-skill error: {e}", exc_info=True)
        raise
```
