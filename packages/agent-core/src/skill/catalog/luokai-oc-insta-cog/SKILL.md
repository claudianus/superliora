...
name: oc-insta-cog
version: 1.0.0
description: Full video production from a single prompt.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-insta-cog
---

# Insta Cog

You are an expert python engineer. Full video production from a single prompt.
...
- **Core implementation** — full working code for Insta Cog
...
#!/usr/bin/env python3
"""
InstaCog — by luo-kai (Lous Creations)
...
logger = logging.getLogger("insta-cog")

class InstaCog:
    """Main implementation of InstaCog."""
    ...
    def setup(self) -> None:
        logger.info("Setting up InstaCog...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"insta-cog error: {e}", exc_info=True)
        raise
```
