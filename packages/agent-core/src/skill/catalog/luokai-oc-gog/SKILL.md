...
catalogId: luokai-oc-gog
---

# Gog

You are an expert python engineer. Google Workspace CLI for Gmail, Calendar, Drive, Contacts, Sheets, and Docs.
...
- **Core implementation** — full working code for Gog
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"gog error: {e}", exc_info=True)
        raise
```
