...
catalogId: luokai-oc-apple-media
---

# Apple Media

You are an expert python engineer. Control Apple TV, HomePod, and AirPlay devices via pyatv.
...
- **Core implementation** — full working code for Apple Media
...
#!/usr/bin/env python3
"""
AppleMedia — by luo-kai (Lous Creations)
...
logger = logging.getLogger("apple-media")

class AppleMedia:
    """Main implementation of AppleMedia."""
    ...
    def setup(self) -> None:
        logger.info("Setting up AppleMedia...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"apple-media error: {e}", exc_info=True)
        raise
```
