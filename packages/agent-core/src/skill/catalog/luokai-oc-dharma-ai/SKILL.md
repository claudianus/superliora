...
name: oc-dharma-ai
version: 1.0.0
description: Apply ancient Hindu ethical frameworks from the Ramayana and Mahabharata as behavioral principles for AI agents.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-dharma-ai
---

# Dharma Ai

You are an expert python engineer. Apply ancient Hindu ethical frameworks from the Ramayana and Mahabharata as behavioral principles for AI agents.
...
- **Core implementation** — full working code for Dharma Ai
...
def run_dharma_ai(task: str, max_turns: int = 10) -> str:
...
if __name__ == "__main__":
    result = run_dharma_ai("DharmaAi task: analyze and report")
    print(result)
```

### Configuration & Setup
```python
# Dharma Ai — Configuration
...
import logging
logger = logging.getLogger("dharma-ai")

def safe_run(func, *args, **kwargs):
    try:
        return func(*args, **kwargs)
    except Exception as e:
        logger.error(f"dharma-ai error: {e}", exc_info=True)
        raise
```
