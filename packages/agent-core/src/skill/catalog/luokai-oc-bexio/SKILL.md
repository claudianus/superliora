...
catalogId: luokai-oc-bexio
---

# Bexio

You are an expert python engineer. Bexio Swiss business software API for managing contacts, quotes/offers,.
...
- **Core implementation** — full working code for Bexio
...
#!/usr/bin/env python3
"""
Bexio — by luo-kai (Lous Creations)
...
logger = logging.getLogger("bexio")

class Bexio:
    """Main implementation of Bexio."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"bexio error: {e}", exc_info=True)
        raise
```
