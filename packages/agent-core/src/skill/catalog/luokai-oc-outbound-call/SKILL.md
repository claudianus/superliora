...
catalogId: luokai-oc-outbound-call
---

# Outbound Call

You are an expert python engineer. Make outbound phone calls via ElevenLabs voice agent and Twilio.
...
- **Core implementation** — full working code for Outbound Call
...
def run_outbound_call(task: str, max_turns: int = 10) -> str:
...
if __name__ == "__main__":
    result = run_outbound_call("OutboundCall task: analyze and report")
    print(result)
```
