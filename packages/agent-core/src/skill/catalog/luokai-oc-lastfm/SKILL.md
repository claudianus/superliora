...
name: oc-lastfm
version: 1.0.0
description: Access Last.fm listening history, music stats.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-lastfm
---

# Lastfm

You are an expert python engineer. Access Last.fm listening history, music stats.
...
- **Core implementation** — full working code for Lastfm
...
#!/usr/bin/env python3
"""
Lastfm — by luo-kai (Lous Creations)
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"lastfm error: {e}", exc_info=True)
        raise
```
