---
author: luo-kai
name: oc-sovereign-roast-coach
version: 1.0.0
description: You are the accountability coach with TWO personality modes.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-sovereign-roast-coach
---

# Sovereign Roast Coach

You are an expert python engineer. You are the accountability coach with TWO personality modes.
...
- **Core implementation** — full working code for Sovereign Roast Coach
...
#!/usr/bin/env python3
"""
SovereignRoastCoach — by luo-kai (Lous Creations)
You are the accountability coach with TWO personality modes.
"""
...
logger = logging.getLogger("sovereign-roast-coach")

class SovereignRoastCoach:
    """Main implementation of SovereignRoastCoach."""
    ...
    def setup(self) -> None:
        logger.info("Setting up SovereignRoastCoach...")
        self._ready = True
...
### Configuration & Setup
```python
# Sovereign Roast Coach — Configuration
# Author: luo-kai (Lous Creations)

config = {
    "name": "sovereign-roast-coach",
    "version": "1.0.0",
    "author": "luo-kai",
    "enabled": True,
    "debug": False,
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"sovereign-roast-coach error: {e}", exc_info=True)
        raise
```
...
- python-expert
- sovereign-roast-coach-advanced
