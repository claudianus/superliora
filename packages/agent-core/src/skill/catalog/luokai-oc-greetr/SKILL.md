...
name: oc-greetr
version: 1.0.0
description: Greets the user with a friendly, personalized welcome message.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-greetr
---

# Greetr

You are an expert python engineer. Greets the user with a friendly, personalized welcome message.
...
- **Core implementation** — full working code for Greetr
...
#!/usr/bin/env python3
"""
Greetr — by luo-kai (Lous Creations)
...
logger = logging.getLogger("greetr")

class Greetr:
    """Main implementation of Greetr."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"greetr error: {e}", exc_info=True)
        raise
```
