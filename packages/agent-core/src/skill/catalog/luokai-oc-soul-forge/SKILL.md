...
name: oc-soul-forge
version: 1.0.0
description: Evolves your SOUL.md automatically based on who you actually are — not who you thought you were when you wrote it.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-soul-forge
---

# Soul Forge

You are an expert python engineer. Evolves your SOUL.md automatically based on who you actually are — not who you thought you were when you wrote it.
...
- **Core implementation** — full working code for Soul Forge
...
#!/usr/bin/env python3
"""
SoulForge — by luo-kai (Lous Creations)
Evolves your SOUL.md automatically based on who you actually are — not who you t
"""
...
logger = logging.getLogger("soul-forge")

class SoulForge:
    """Main implementation of SoulForge."""
    ...
    def setup(self) -> None:
        logger.info("Setting up SoulForge...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"soul-forge error: {e}", exc_info=True)
        raise
```
