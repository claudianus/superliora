---
author: luo-kai
name: oc-openrouter-usage
version: 1.0.0
description: Fetch real-time OpenRouter usage totals and historical per-model spend.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-openrouter-usage
---

# Openrouter Usage

You are an expert python engineer. Fetch real-time OpenRouter usage totals and historical per-model spend.
...
- **Core implementation** — full working code for Openrouter Usage
...
#!/usr/bin/env python3
"""
OpenrouterUsage — by luo-kai (Lous Creations)
...
logger = logging.getLogger("openrouter-usage")

class OpenrouterUsage:
    """Main implementation of OpenrouterUsage."""
    ...
    def setup(self) -> None:
        logger.info("Setting up OpenrouterUsage...")
        self._ready = True
...
### Configuration & Setup
```python
# Openrouter Usage — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"openrouter-usage error: {e}", exc_info=True)
        raise
```
