...
name: oc-code-tester
version: 1.0.0
description: Build, run, and test code projects for Rust, Go, and Java.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-code-tester
---

# Code Tester

You are an expert python engineer. Build, run, and test code projects for Rust, Go, and Java.
...
- **Core implementation** — full working code for Code Tester
...
#!/usr/bin/env python3
"""
CodeTester — by luo-kai (Lous Creations)
Build, run, and test code projects for Rust, Go, and Java.
"""
...
class CodeTester:
    """Main implementation of CodeTester."""
    ...
    def setup(self) -> None:
        logger.info("Setting up CodeTester...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"code-tester error: {e}", exc_info=True)
        raise
```
