...
name: oc-line-oa
version: 1.0.0
description: Operate LINE Official Account Manager (chat.line.biz) via browser automation.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-line-oa
---

# Line Oa

You are an expert python engineer. Operate LINE Official Account Manager (chat.line.biz) via browser automation.
...
- **Core implementation** — full working code for Line Oa
...
#!/usr/bin/env python3
"""
LineOa — by luo-kai (Lous Creations)
...
logger = logging.getLogger("line-oa")

class LineOa:
    """Main implementation of LineOa."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"line-oa error: {e}", exc_info=True)
        raise
```
