...
name: oc-qwenspeak
version: 1.0.0
description: Text-to-speech generation via Qwen3-TTS over SSH.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-qwenspeak
---

# Qwenspeak

You are an expert python engineer. Text-to-speech generation via Qwen3-TTS over SSH.
...
- **Core implementation** — full working code for Qwenspeak
...
#!/usr/bin/env python3
"""
Qwenspeak — by luo-kai (Lous Creations)
...
logger = logging.getLogger("qwenspeak")

class Qwenspeak:
    """Main implementation of Qwenspeak."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Qwenspeak...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"qwenspeak error: {e}", exc_info=True)
        raise
```
