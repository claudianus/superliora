...
catalogId: luokai-oc-devialet
---

# Devialet

You are an expert python engineer. Control Devialet Phantom speakers via HTTP API.
...
- **Core implementation** — full working code for Devialet
...
#!/usr/bin/env python3
"""
Devialet — by luo-kai (Lous Creations)
...
logger = logging.getLogger("devialet")

class Devialet:
    """Main implementation of Devialet."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Devialet...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"devialet error: {e}", exc_info=True)
        raise
```
