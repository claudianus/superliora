...
catalogId: luokai-oc-smart-context
---
...
Install via: `npx clawhub install smart-context`

## Core Functionality
Refer to the original skill documentation at: https://clawskills.sh/skills/smart-context

This skill enables: Token-efficient agent behavior — response sizing, context pruning, tool efficiency, and delegation.
