...
name: oc-music-cog
version: 1.0.0
description: Original music, fully yours.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-music-cog
---

# Music Cog

You are an expert python engineer. Original music, fully yours.
...
- **Core implementation** — full working code for Music Cog
...
#!/usr/bin/env python3
"""
MusicCog — by luo-kai (Lous Creations)
...
class MusicCog:
    """Main implementation of MusicCog."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"music-cog error: {e}", exc_info=True)
        raise
```
