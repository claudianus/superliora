---
author: luo-kai
name: oc-skill-shield
version: 1.0.0
description: Security audit tool for ClawHub skills.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-skill-shield
---

# Skill Shield

You are an expert python engineer. Security audit tool for ClawHub skills.
...
- **Core implementation** — full working code for Skill Shield
...
class SkillShieldSecureInput(BaseModel):
...
import logging
logger = logging.getLogger("skill-shield")

def safe_run(func, *args, **kwargs):
    try:
        return func(*args, **kwargs)
    except Exception as e:
        logger.error(f"skill-shield error: {e}", exc_info=True)
        raise
```
