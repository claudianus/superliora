...
name: oc-firefly
version: 1.0.0
description: Fetch meeting transcripts, summaries, and action items from Firefly AI (fireflies.ai)
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-firefly
---

# Firefly

You are an expert python engineer. Fetch meeting transcripts, summaries, and action items from Firefly AI (fireflies.ai)
...
- **Core implementation** — full working code for Firefly
...
#!/usr/bin/env python3
"""
Firefly — by luo-kai (Lous Creations)
Fetch meeting transcripts, summaries, and action items from Firefly AI (fireflie
"""
...
class Firefly:
    """Main implementation of Firefly."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Firefly...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"firefly error: {e}", exc_info=True)
        raise
```
