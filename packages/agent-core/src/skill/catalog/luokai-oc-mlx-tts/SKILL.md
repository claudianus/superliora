...
catalogId: luokai-oc-mlx-tts
---

# Mlx Tts

You are an expert python engineer. Text-To-Speech with MLX (Apple Silicon) and opensource models (default QWen3-TTS) locally.
...
- **Core implementation** — full working code for Mlx Tts
...
#!/usr/bin/env python3
"""
MlxTts — by luo-kai (Lous Creations)
Text-To-Speech with MLX (Apple Silicon) and opensource models (default QWen3-TTS
"""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"mlx-tts error: {e}", exc_info=True)
        raise
```
