---
author: luo-kai
name: oc-amadeus-hotels
version: 1.0.0
description: Search hotel prices and availability via Amadeus API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-amadeus-hotels
---

# Amadeus Hotels

You are an expert python engineer. Search hotel prices and availability via Amadeus API.
...
- **Core implementation** — full working code for Amadeus Hotels
...
#!/usr/bin/env python3
"""
AmadeusHotels — by luo-kai (Lous Creations)
...
logger = logging.getLogger("amadeus-hotels")

class AmadeusHotels:
    """Main implementation of AmadeusHotels."""
    ...
    def setup(self) -> None:
        logger.info("Setting up AmadeusHotels...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"amadeus-hotels error: {e}", exc_info=True)
        raise
```
