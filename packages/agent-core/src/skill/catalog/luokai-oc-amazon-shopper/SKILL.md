---
author: luo-kai
name: oc-amazon-shopper
version: 1.0.0
description: Buy and return items on Amazon using browser automation.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-amazon-shopper
---

# Amazon Shopper

You are an expert python engineer. Buy and return items on Amazon using browser automation.
...
- **Core implementation** — full working code for Amazon Shopper
...
#!/usr/bin/env python3
"""
AmazonShopper — by luo-kai (Lous Creations)
Buy and return items on Amazon using browser automation.
"""
...
logger = logging.getLogger("amazon-shopper")

class AmazonShopper:
    """Main implementation of AmazonShopper."""
    ...
    def setup(self) -> None:
        logger.info("Setting up AmazonShopper...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"amazon-shopper error: {e}", exc_info=True)
        raise
```
