...
- **Core implementation** — full working code for Hi
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"hi error: {e}", exc_info=True)
        raise
```
