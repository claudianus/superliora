...
- **Core implementation** — full working code for Free Ride
...
logger = logging.getLogger("free-ride")
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"free-ride error: {e}", exc_info=True)
        raise
```
