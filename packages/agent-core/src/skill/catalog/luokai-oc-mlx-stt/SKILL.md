...
catalogId: luokai-oc-mlx-stt
---

# Mlx Stt

You are an expert python engineer. Speech-To-Text with MLX (Apple Silicon) and GLM-ASR-Nano-2512 locally.
...
- **Core implementation** — full working code for Mlx Stt
...
#!/usr/bin/env python3
"""
MlxStt — by luo-kai (Lous Creations)
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"mlx-stt error: {e}", exc_info=True)
        raise
```
