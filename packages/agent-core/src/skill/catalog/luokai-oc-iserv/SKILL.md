...
name: oc-iserv
version: 1.0.0
description: HTTP client for IServ school platforms.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-iserv
---

# Iserv

You are an expert python engineer. HTTP client for IServ school platforms.
...
- **Core implementation** — full working code for Iserv
...
#!/usr/bin/env python3
"""
Iserv — by luo-kai (Lous Creations)
HTTP client for IServ school platforms.
"""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"iserv error: {e}", exc_info=True)
        raise
```
