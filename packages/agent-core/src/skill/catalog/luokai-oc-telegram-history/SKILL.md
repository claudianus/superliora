---
author: luo-kai
name: oc-telegram-history
version: 1.0.0
description: Fetch Telegram chat message history via MTProto user API (Telethon)
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-telegram-history
---

# Telegram History

You are an expert python engineer. Fetch Telegram chat message history via MTProto user API (Telethon)
...
- **Core implementation** — full working code for Telegram History
...
#!/usr/bin/env python3
"""
TelegramHistory — by luo-kai (Lous Creations)
...
logger = logging.getLogger("telegram-history")

class TelegramHistory:
    """Main implementation of TelegramHistory."""
    ...
    def setup(self) -> None:
        logger.info("Setting up TelegramHistory...")
        self._ready = True
...
### Configuration & Setup
```python
# Telegram History — Configuration
