...
catalogId: luokai-oc-instagram-scraper
---

# Instagram Scraper

You are an expert python engineer. A browser-based Instagram profile discovery and scraping tool.
...
- **Core implementation** — full working code for Instagram Scraper
...
#!/usr/bin/env python3
"""
InstagramScraper — by luo-kai (Lous Creations)
...
class InstagramScraper:
    """Main implementation of InstagramScraper."""
    ...
    def setup(self) -> None:
        logger.info("Setting up InstagramScraper...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"instagram-scraper error: {e}", exc_info=True)
        raise
```
