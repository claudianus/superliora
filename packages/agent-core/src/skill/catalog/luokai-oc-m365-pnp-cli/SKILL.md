---
author: luo-kai
name: oc-m365-pnp-cli
version: 1.0.0
description: CLI for Microsoft 365 - Manage Microsoft 365 tenant, SharePoint Online, Teams, OneDrive.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-m365-pnp-cli
---

# M365 Pnp Cli

You are an expert python engineer. CLI for Microsoft 365 - Manage Microsoft 365 tenant, SharePoint Online, Teams, OneDrive.
...
- **Core implementation** — full working code for M365 Pnp Cli
...
#!/usr/bin/env python3
"""
M365PnpCli — by luo-kai (Lous Creations)
CLI for Microsoft 365 - Manage Microsoft 365 tenant, SharePoint Online, Teams, O
"""
...
logger = logging.getLogger("m365-pnp-cli")

class M365PnpCli:
    """Main implementation of M365PnpCli."""
    ...
    def setup(self) -> None:
        logger.info("Setting up M365PnpCli...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"m365-pnp-cli error: {e}", exc_info=True)
        raise
```
