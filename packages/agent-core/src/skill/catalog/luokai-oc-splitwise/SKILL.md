...
name: oc-splitwise
version: 1.0.0
description: Create and manage expenses on Splitwise.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-splitwise
---

# Splitwise

You are an expert python engineer. Create and manage expenses on Splitwise.
...
- **Core implementation** — full working code for Splitwise
...
#!/usr/bin/env python3
"""
Splitwise — by luo-kai (Lous Creations)
...
class Splitwise:
    """Main implementation of Splitwise."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Splitwise...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"splitwise error: {e}", exc_info=True)
        raise
```
