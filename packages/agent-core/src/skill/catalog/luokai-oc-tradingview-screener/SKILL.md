---
author: luo-kai
name: oc-tradingview-screener
version: 1.0.0
description: Screen markets across 6 asset classes using TradingView data.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-tradingview-screener
---

# Tradingview Screener

You are an expert python engineer. Screen markets across 6 asset classes using TradingView data.
...
- **Core implementation** — full working code for Tradingview Screener
...
logger = logging.getLogger("tradingview-screener")
...
def run_tradingview_screener(source: str, dest: str) -> dict:
    raw = extract(source)
    clean = transform(raw)
    load(clean, dest)
