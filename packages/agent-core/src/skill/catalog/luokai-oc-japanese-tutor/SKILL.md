...
catalogId: luokai-oc-japanese-tutor
---

# Japanese Tutor

You are an expert python engineer. Interactive Japanese learning assistant.
...
- **Core implementation** — full working code for Japanese Tutor
...
#!/usr/bin/env python3
"""
JapaneseTutor — by luo-kai (Lous Creations)
...
logger = logging.getLogger("japanese-tutor")

class JapaneseTutor:
    """Main implementation of JapaneseTutor."""
    ...
    def setup(self) -> None:
        logger.info("Setting up JapaneseTutor...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"japanese-tutor error: {e}", exc_info=True)
        raise
```
