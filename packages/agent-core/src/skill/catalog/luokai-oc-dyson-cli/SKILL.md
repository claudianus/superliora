...
catalogId: luokai-oc-dyson-cli
---

# Dyson Cli

You are an expert python engineer. Control Dyson air purifiers, fans, and heaters via local MQTT.
...
- **Core implementation** — full working code for Dyson Cli
...
#!/usr/bin/env python3
"""
DysonCli — by luo-kai (Lous Creations)
...
logger = logging.getLogger("dyson-cli")

class DysonCli:
    """Main implementation of DysonCli."""
    ...
    def setup(self) -> None:
        logger.info("Setting up DysonCli...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"dyson-cli error: {e}", exc_info=True)
        raise
```
