---
author: luo-kai
name: oc-voice-to-text
version: 1.0.0
description: Convert voice messages and audio files to text using Vosk offline speech recognition.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-voice-to-text
---

# Voice To Text

You are an expert python engineer. Convert voice messages and audio files to text using Vosk offline speech recognition.
...
- **Core implementation** — full working code for Voice To Text
...
#!/usr/bin/env python3
"""
VoiceToText — by luo-kai (Lous Creations)
Convert voice messages and audio files to text using Vosk offline speech recogni
"""
...
class VoiceToText:
    """Main implementation of VoiceToText."""
    ...
    def setup(self) -> None:
        logger.info("Setting up VoiceToText...")
        self._ready = True
