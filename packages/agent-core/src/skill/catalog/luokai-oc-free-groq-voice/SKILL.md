---
author: luo-kai
name: oc-free-groq-voice
version: 1.0.0
description: FREE voice recognition using Groq's complimentary Whisper API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-free-groq-voice
---

# Free Groq Voice

You are an expert python engineer. FREE voice recognition using Groq's complimentary Whisper API.
...
- **Core implementation** — full working code for Free Groq Voice
...
#!/usr/bin/env python3
"""
FreeGroqVoice — by luo-kai (Lous Creations)
...
logger = logging.getLogger("free-groq-voice")

class FreeGroqVoice:
    """Main implementation of FreeGroqVoice."""
    ...
    def setup(self) -> None:
        logger.info("Setting up FreeGroqVoice...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"free-groq-voice error: {e}", exc_info=True)
        raise
```
