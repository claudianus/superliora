---
author: luo-kai
name: oc-hz-context-optimizer
version: 1.0.0
description: This skill should be used when the user asks to "compress context", "summarize conversation history", "implement.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-hz-context-optimizer
---

# Hz Context Optimizer

You are an expert python engineer. This skill should be used when the user asks to "compress context", "summarize conversation history", "implement.
...
- **Core implementation** — full working code for Hz Context Optimizer
...
#!/usr/bin/env python3
"""
HzContextOptimizer — by luo-kai (Lous Creations)
This skill should be used when the user asks to "compress context", "summarize c
"""
...
logger = logging.getLogger("hz-context-optimizer")

class HzContextOptimizer:
    """Main implementation of HzContextOptimizer."""
    ...
    def setup(self) -> None:
        logger.info("Setting up HzContextOptimizer...")
        self._ready = True
...
### Configuration & Setup
```python
# Hz Context Optimizer — Configuration
# Author: luo-kai (Lous Creations)

config = {
    "name": "hz-context-optimizer",
    "version": "1.0.0",
    "author": "luo-kai",
    "enabled": True,
    "debug": False,
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"hz-context-optimizer error: {e}", exc_info=True)
        raise
```
