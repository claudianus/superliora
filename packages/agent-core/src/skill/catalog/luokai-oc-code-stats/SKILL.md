...
name: oc-code-stats
version: 1.0.0
description: Visualizes repository complexity by counting files, lines of code, and grouping by extension.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-code-stats
---

# Code Stats

You are an expert python engineer. Visualizes repository complexity by counting files, lines of code, and grouping by extension.
...
- **Core implementation** — full working code for Code Stats
...
#!/usr/bin/env python3
"""
CodeStats — by luo-kai (Lous Creations)
Visualizes repository complexity by counting files, lines of code, and grouping 
"""
...
logger = logging.getLogger("code-stats")

class CodeStats:
    """Main implementation of CodeStats."""
    ...
    def setup(self) -> None:
        logger.info("Setting up CodeStats...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"code-stats error: {e}", exc_info=True)
        raise
```
