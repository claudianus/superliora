...
catalogId: luokai-oc-asr
---

# Asr

You are an expert python engineer. Fast, accurate, and incredibly inexpensive automatic speech-to-text.
...
- **Core implementation** — full working code for Asr
