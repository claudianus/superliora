---
author: luo-kai
name: oc-minimax-speech
version: 1.0.0
description: Manage MiniMax Speech 2.8 T2A (text-to-audio) and voice catalog lookups.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-minimax-speech
---

# Minimax Speech

You are an expert python engineer. Manage MiniMax Speech 2.8 T2A (text-to-audio) and voice catalog lookups.
...
- **Core implementation** — full working code for Minimax Speech
...
#!/usr/bin/env python3
"""
MinimaxSpeech — by luo-kai (Lous Creations)
...
logger = logging.getLogger("minimax-speech")

class MinimaxSpeech:
    """Main implementation of MinimaxSpeech."""
    ...
    def setup(self) -> None:
        logger.info("Setting up MinimaxSpeech...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"minimax-speech error: {e}", exc_info=True)
        raise
```
