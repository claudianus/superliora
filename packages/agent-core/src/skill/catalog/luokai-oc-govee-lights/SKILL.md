...
catalogId: luokai-oc-govee-lights
---

# Govee Lights

You are an expert python engineer. Control Govee smart lights via the Govee API.
...
- **Core implementation** — full working code for Govee Lights
...
#!/usr/bin/env python3
"""
GoveeLights — by luo-kai (Lous Creations)
...
logger = logging.getLogger("govee-lights")

class GoveeLights:
    """Main implementation of GoveeLights."""
    ...
    def setup(self) -> None:
        logger.info("Setting up GoveeLights...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"govee-lights error: {e}", exc_info=True)
        raise
```
