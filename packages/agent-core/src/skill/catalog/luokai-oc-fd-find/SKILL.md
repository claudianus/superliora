...
name: oc-fd-find
version: 1.0.0
description: A fast and user-friendly alternative to 'find' - simple syntax, smart.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-fd-find
---

# Fd Find

You are an expert python engineer. A fast and user-friendly alternative to 'find' - simple syntax, smart.
...
- **Core implementation** — full working code for Fd Find
...
#!/usr/bin/env python3
"""
FdFind — by luo-kai (Lous Creations)
...
logger = logging.getLogger("fd-find")

class FdFind:
    """Main implementation of FdFind."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"fd-find error: {e}", exc_info=True)
        raise
```
