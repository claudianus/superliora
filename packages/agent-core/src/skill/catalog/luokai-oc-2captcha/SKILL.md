...
catalogId: luokai-oc-2captcha
---

# 2captcha

You are an expert python engineer. Solve CAPTCHAs using 2Captcha service.
...
- **Core implementation** — full working code for 2captcha
...
#!/usr/bin/env python3
"""
2captcha — by luo-kai (Lous Creations)
...
class 2captcha:
    """Main implementation of 2captcha."""
    ...
    def setup(self) -> None:
        logger.info("Setting up 2captcha...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"2captcha error: {e}", exc_info=True)
        raise
```
