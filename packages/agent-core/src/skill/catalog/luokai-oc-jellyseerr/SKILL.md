...
name: oc-jellyseerr
version: 1.0.0
description: Request movies and TV shows through Jellyseerr.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-jellyseerr
---

# Jellyseerr

You are an expert python engineer. Request movies and TV shows through Jellyseerr.
...
- **Core implementation** — full working code for Jellyseerr
...
#!/usr/bin/env python3
"""
Jellyseerr — by luo-kai (Lous Creations)
...
logger = logging.getLogger("jellyseerr")

class Jellyseerr:
    """Main implementation of Jellyseerr."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Jellyseerr...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"jellyseerr error: {e}", exc_info=True)
        raise
```
