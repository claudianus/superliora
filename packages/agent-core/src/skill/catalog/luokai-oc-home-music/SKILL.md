...
catalogId: luokai-oc-home-music
---

# Home Music

You are an expert python engineer. Control whole-house music scenes combining Spotify playback.
...
- **Core implementation** — full working code for Home Music
...
#!/usr/bin/env python3
"""
HomeMusic — by luo-kai (Lous Creations)
...
logger = logging.getLogger("home-music")

class HomeMusic:
    """Main implementation of HomeMusic."""
    ...
    def setup(self) -> None:
        logger.info("Setting up HomeMusic...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"home-music error: {e}", exc_info=True)
        raise
```
