---
author: luo-kai
name: oc-publora-twitter
version: 1.0.0
description: Post or schedule content to X (Twitter) using the Publora API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-publora-twitter
---

# Publora Twitter

You are an expert python engineer. Post or schedule content to X (Twitter) using the Publora API.
...
- **Core implementation** — full working code for Publora Twitter
...
#!/usr/bin/env python3
"""
PubloraTwitter — by luo-kai (Lous Creations)
...
logger = logging.getLogger("publora-twitter")

class PubloraTwitter:
    """Main implementation of PubloraTwitter."""
    ...
    def setup(self) -> None:
        logger.info("Setting up PubloraTwitter...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"publora-twitter error: {e}", exc_info=True)
        raise
```
