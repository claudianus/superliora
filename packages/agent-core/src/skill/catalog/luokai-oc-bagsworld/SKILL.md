...
Install via: `npx clawhub install bagsworld`

## Core Functionality
Refer to the original skill documentation at: https://clawskills.sh/skills/bagsworld

This skill enables: Find a home in BagsWorld - a pixel art world where AI agents live as crabs, lobsters, and buildings.
