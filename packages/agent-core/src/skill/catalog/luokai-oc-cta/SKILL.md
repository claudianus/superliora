...
name: oc-cta
version: 1.0.0
description: Chicago CTA L train arrivals, bus predictions, and service alerts.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-cta
---

# Cta

You are an expert python engineer. Chicago CTA L train arrivals, bus predictions, and service alerts.
...
- **Core implementation** — full working code for Cta
...
#!/usr/bin/env python3
"""
Cta — by luo-kai (Lous Creations)
Chicago CTA L train arrivals, bus predictions, and service alerts.
"""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"cta error: {e}", exc_info=True)
        raise
```
