...
catalogId: luokai-oc-decompose-mcp
---
...
Install via: `npx clawhub install decompose-mcp`

## Core Functionality
Refer to the original skill documentation at: https://clawskills.sh/skills/decompose-mcp

This skill enables: Decompose any text into classified semantic units — authority, risk, attention, entities.
