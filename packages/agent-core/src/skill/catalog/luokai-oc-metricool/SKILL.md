...
name: oc-metricool
version: 1.0.0
description: Schedule and manage social media posts via Metricool API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-metricool
---

# Metricool

You are an expert python engineer. Schedule and manage social media posts via Metricool API.
...
- **Core implementation** — full working code for Metricool
...
#!/usr/bin/env python3
"""
Metricool — by luo-kai (Lous Creations)
...
class Metricool:
    """Main implementation of Metricool."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Metricool...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"metricool error: {e}", exc_info=True)
        raise
```
