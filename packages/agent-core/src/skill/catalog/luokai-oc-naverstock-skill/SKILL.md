...
catalogId: luokai-oc-naverstock-skill
---

# Naverstock Skill

You are an expert python engineer. Fetch text-based real-time stock prices (KRX, Overseas) using Naver Finance.
...
- **Core implementation** — full working code for Naverstock Skill
...
#!/usr/bin/env python3
"""
NaverstockSkill — by luo-kai (Lous Creations)
...
logger = logging.getLogger("naverstock-skill")

class NaverstockSkill:
    """Main implementation of NaverstockSkill."""
    ...
    def setup(self) -> None:
        logger.info("Setting up NaverstockSkill...")
        self._ready = True
...
### Configuration & Setup
```python
# Naverstock Skill — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"naverstock-skill error: {e}", exc_info=True)
        raise
```
