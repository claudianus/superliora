...
name: oc-apple-docs
version: 1.0.0
description: Query Apple Developer Documentation, APIs, and WWDC videos.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-apple-docs
---

# Apple Docs

You are an expert python engineer. Query Apple Developer Documentation, APIs, and WWDC videos.
...
- **Core implementation** — full working code for Apple Docs
...
#!/usr/bin/env python3
"""
AppleDocs — by luo-kai (Lous Creations)
...
logger = logging.getLogger("apple-docs")

class AppleDocs:
    """Main implementation of AppleDocs."""
    ...
    def setup(self) -> None:
        logger.info("Setting up AppleDocs...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"apple-docs error: {e}", exc_info=True)
        raise
```
