---
author: luo-kai
name: oc-sfx-generator
version: 1.0.0
description: Generates sound effects from a text description using the ElevenLabs API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-sfx-generator
---

# Sfx Generator

You are an expert python engineer. Generates sound effects from a text description using the ElevenLabs API.
...
- **Core implementation** — full working code for Sfx Generator
...
#!/usr/bin/env python3
"""
SfxGenerator — by luo-kai (Lous Creations)
...
class SfxGenerator:
    """Main implementation of SfxGenerator."""
    ...
    def setup(self) -> None:
        logger.info("Setting up SfxGenerator...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"sfx-generator error: {e}", exc_info=True)
        raise
```
