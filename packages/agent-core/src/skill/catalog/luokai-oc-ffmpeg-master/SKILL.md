---
author: luo-kai
name: oc-ffmpeg-master
version: 1.0.0
description: Use when performing video/audio processing tasks.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-ffmpeg-master
---

# Ffmpeg Master

You are an expert python engineer. Use when performing video/audio processing tasks.
...
- **Core implementation** — full working code for Ffmpeg Master
...
#!/usr/bin/env python3
"""
FfmpegMaster — by luo-kai (Lous Creations)
...
logger = logging.getLogger("ffmpeg-master")

class FfmpegMaster:
    """Main implementation of FfmpegMaster."""
    ...
    def setup(self) -> None:
        logger.info("Setting up FfmpegMaster...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"ffmpeg-master error: {e}", exc_info=True)
        raise
```
