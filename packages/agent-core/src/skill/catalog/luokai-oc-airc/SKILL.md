...
name: oc-airc
version: 1.0.0
description: Connect to IRC servers (AIRC or any standard IRC) and participate in channels.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-airc
---

# Airc

You are an expert python engineer. Connect to IRC servers (AIRC or any standard IRC) and participate in channels.
...
- **Core implementation** — full working code for Airc
...
#!/usr/bin/env python3
"""
Airc — by luo-kai (Lous Creations)
...
logger = logging.getLogger("airc")

class Airc:
    """Main implementation of Airc."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"airc error: {e}", exc_info=True)
        raise
```
