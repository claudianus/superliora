...
req = urllib.request.Request('https://api.maton.ai/google-ads/v23/customers:listAccessibleCustomers')
...
req = urllib.request.Request('https://api.maton.ai/google-ads/v23/customers/1234567890/googleAds:search', data=data, method='POST')
req.add_header('Authorization', f'Bearer {os.environ["MATON_API_KEY"]}')
req.add_header('Content-Type', 'application/json')
...
const customers = await fetch(
  'https://api.maton.ai/google-ads/v23/customers:listAccessibleCustomers',
  { headers: { 'Authorization': `Bearer ${process.env.MATON_API_KEY}` } }
).then(r => r.json());

// Query campaigns
const campaigns = await fetch(
  `https://api.maton.ai/google-ads/v23/customers/${customerId}/googleAds:search`,
  {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
...
response = requests.post(
    f'https://api.maton.ai/google-ads/v23/customers/{customer_id}/googleAds:search',
    headers=headers,
...
- Correct: `https://api.maton.ai/google-ads/v23/customers:listAccessibleCustomers`
- Incorrect: `https://api.maton.ai/v23/customers:listAccessibleCustomers`
