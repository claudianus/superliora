---
author: luo-kai
name: oc-feishu-meeting-assistant
version: 1.0.0
description: Scans your Feishu Calendar for upcoming events with attached documents (Doc, Sheet, Bitable), reads their content.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-feishu-meeting-assistant
---

# Feishu Meeting Assistant

You are an expert python engineer. Scans your Feishu Calendar for upcoming events with attached documents (Doc, Sheet, Bitable), reads their content.
...
- **Core implementation** — full working code for Feishu Meeting Assistant
...
#!/usr/bin/env python3
"""
FeishuMeetingAssistant — by luo-kai (Lous Creations)
Scans your Feishu Calendar for upcoming events with attached documents (Doc, She
"""
...
logger = logging.getLogger("feishu-meeting-assistant")

class FeishuMeetingAssistant:
    """Main implementation of FeishuMeetingAssistant."""
    ...
    def setup(self) -> None:
        logger.info("Setting up FeishuMeetingAssistant...")
        self._ready = True
...
### Configuration & Setup
```python
# Feishu Meeting Assistant — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"feishu-meeting-assistant error: {e}", exc_info=True)
        raise
```
...
- python-expert
- feishu-meeting-assistant-advanced
