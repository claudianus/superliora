...
name: oc-strapi
version: 1.0.0
description: Manage Strapi CMS content through the official @strapi/client SDK.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-strapi
---

# Strapi

You are an expert python engineer. Manage Strapi CMS content through the official @strapi/client SDK.
...
- **Core implementation** — full working code for Strapi
...
#!/usr/bin/env python3
"""
Strapi — by luo-kai (Lous Creations)
...
logger = logging.getLogger("strapi")

class Strapi:
    """Main implementation of Strapi."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"strapi error: {e}", exc_info=True)
        raise
```
