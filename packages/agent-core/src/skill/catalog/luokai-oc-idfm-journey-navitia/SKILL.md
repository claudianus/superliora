---
author: luo-kai
name: oc-idfm-journey-navitia
version: 1.0.0
description: Query Île-de-France Mobilités (IDFM) PRIM/Navitia.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-idfm-journey-navitia
---

# Idfm Journey Navitia

You are an expert python engineer. Query Île-de-France Mobilités (IDFM) PRIM/Navitia.
...
- **Core implementation** — full working code for Idfm Journey Navitia
...
#!/usr/bin/env python3
"""
IdfmJourneyNavitia — by luo-kai (Lous Creations)
...
logger = logging.getLogger("idfm-journey-navitia")

class IdfmJourneyNavitia:
    """Main implementation of IdfmJourneyNavitia."""
    ...
    def setup(self) -> None:
        logger.info("Setting up IdfmJourneyNavitia...")
        self._ready = True
...
### Configuration & Setup
```python
# Idfm Journey Navitia — Configuration
# Author: luo-kai (Lous Creations)

config = {
    "name": "idfm-journey-navitia",
    "version": "1.0.0",
    "author": "luo-kai",
    "enabled": True,
    "debug": False,
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"idfm-journey-navitia error: {e}", exc_info=True)
        raise
```
