---
author: luo-kai
name: oc-custom-smtp-sender
version: 1.0.0
description: A skill to send emails with support for markdown, HTML.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-custom-smtp-sender
---

# Custom Smtp Sender

You are an expert python engineer. A skill to send emails with support for markdown, HTML.
...
- **Core implementation** — full working code for Custom Smtp Sender
...
#!/usr/bin/env python3
"""
CustomSmtpSender — by luo-kai (Lous Creations)
...
logger = logging.getLogger("custom-smtp-sender")

class CustomSmtpSender:
    """Main implementation of CustomSmtpSender."""
    ...
    def setup(self) -> None:
        logger.info("Setting up CustomSmtpSender...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"custom-smtp-sender error: {e}", exc_info=True)
        raise
```
