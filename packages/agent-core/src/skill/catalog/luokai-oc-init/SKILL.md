...
- **Core implementation** — full working code for Init
...
def run_init(task: str, max_turns: int = 10) -> str:
...
if __name__ == "__main__":
    result = run_init("Init task: analyze and report")
    print(result)
```
