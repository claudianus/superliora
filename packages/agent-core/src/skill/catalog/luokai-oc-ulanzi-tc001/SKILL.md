---
author: luo-kai
name: oc-ulanzi-tc001
version: 1.0.0
description: Control the Ulanzi TC001 (Pixel Clock) over local HTTP.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-ulanzi-tc001
---

# Ulanzi Tc001

You are an expert python engineer. Control the Ulanzi TC001 (Pixel Clock) over local HTTP.
...
- **Core implementation** — full working code for Ulanzi Tc001
...
#!/usr/bin/env python3
"""
UlanziTc001 — by luo-kai (Lous Creations)
...
logger = logging.getLogger("ulanzi-tc001")

class UlanziTc001:
    """Main implementation of UlanziTc001."""
    ...
    def setup(self) -> None:
        logger.info("Setting up UlanziTc001...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"ulanzi-tc001 error: {e}", exc_info=True)
        raise
```
