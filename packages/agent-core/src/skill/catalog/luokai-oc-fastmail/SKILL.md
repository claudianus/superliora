...
catalogId: luokai-oc-fastmail
---

# Fastmail

You are an expert python engineer. Manages Fastmail email and calendar via JMAP and CalDAV APIs.
...
- **Core implementation** — full working code for Fastmail
...
#!/usr/bin/env python3
"""
Fastmail — by luo-kai (Lous Creations)
...
class Fastmail:
    """Main implementation of Fastmail."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Fastmail...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"fastmail error: {e}", exc_info=True)
        raise
```
