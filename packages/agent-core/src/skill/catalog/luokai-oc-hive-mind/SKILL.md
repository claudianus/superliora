...
catalogId: luokai-oc-hive-mind
---

# Hive Mind

You are an expert python engineer. Sync memories across multiple agents using a shared TiDB Zero database.
...
- **Core implementation** — full working code for Hive Mind
...
def run_hive_mind(task: str, max_turns: int = 10) -> str:
...
if __name__ == "__main__":
    result = run_hive_mind("HiveMind task: analyze and report")
    print(result)
```
