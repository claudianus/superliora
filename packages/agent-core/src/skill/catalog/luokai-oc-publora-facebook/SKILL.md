---
author: luo-kai
name: oc-publora-facebook
version: 1.0.0
description: Post or schedule content to Facebook Pages using the Publora API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-publora-facebook
---

# Publora Facebook

You are an expert python engineer. Post or schedule content to Facebook Pages using the Publora API.
...
- **Core implementation** — full working code for Publora Facebook
...
#!/usr/bin/env python3
"""
PubloraFacebook — by luo-kai (Lous Creations)
...
logger = logging.getLogger("publora-facebook")

class PubloraFacebook:
    """Main implementation of PubloraFacebook."""
    ...
    def setup(self) -> None:
        logger.info("Setting up PubloraFacebook...")
        self._ready = True
...
### Configuration & Setup
```python
# Publora Facebook — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"publora-facebook error: {e}", exc_info=True)
        raise
```
