...
name: oc-stripe
version: 1.0.0
description: Easy-to-use agentic wallets powered by Stripe.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-stripe
---

# Stripe

You are an expert python engineer. Easy-to-use agentic wallets powered by Stripe.
...
- **Core implementation** — full working code for Stripe
...
def run_stripe(task: str, max_turns: int = 10) -> str:
...
if __name__ == "__main__":
    result = run_stripe("Stripe task: analyze and report")
    print(result)
```
