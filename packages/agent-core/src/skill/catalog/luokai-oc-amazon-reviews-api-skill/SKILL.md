---
author: luo-kai
name: oc-amazon-reviews-api-skill
version: 1.0.0
description: This skill helps users automatically extract Amazon product reviews via the Amazon Reviews API.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-amazon-reviews-api-skill
---

# Amazon Reviews Api Skill

You are an expert python engineer. This skill helps users automatically extract Amazon product reviews via the Amazon Reviews API.
...
- **Core implementation** — full working code for Amazon Reviews Api Skill
...
#!/usr/bin/env python3
"""
AmazonReviewsApiSkill — by luo-kai (Lous Creations)
This skill helps users automatically extract Amazon product reviews via the Amaz
"""
...
logger = logging.getLogger("amazon-reviews-api-skill")

class AmazonReviewsApiSkill:
    """Main implementation of AmazonReviewsApiSkill."""
    ...
    def setup(self) -> None:
        logger.info("Setting up AmazonReviewsApiSkill...")
        self._ready = True
...
### Configuration & Setup
```python
# Amazon Reviews Api Skill — Configuration
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"amazon-reviews-api-skill error: {e}", exc_info=True)
        raise
```
...
- python-expert
- amazon-reviews-api-skill-advanced
