---
author: luo-kai
name: oc-client-discovery
version: 1.0.0
description: Run discovery conversations that qualify prospects, diagnose real problems, and position your solution.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-client-discovery
---

# Client Discovery

You are an expert python engineer. Run discovery conversations that qualify prospects, diagnose real problems, and position your solution.
...
- **Core implementation** — full working code for Client Discovery
...
#!/usr/bin/env python3
"""
ClientDiscovery — by luo-kai (Lous Creations)
Run discovery conversations that qualify prospects, diagnose real problems, and 
"""
...
logger = logging.getLogger("client-discovery")

class ClientDiscovery:
    """Main implementation of ClientDiscovery."""
    ...
    def setup(self) -> None:
        logger.info("Setting up ClientDiscovery...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"client-discovery error: {e}", exc_info=True)
        raise
```
