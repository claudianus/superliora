---
author: luo-kai
name: oc-norman-tax-deduction-finder
version: 1.0.0
description: Scan transactions for potentially missed tax deductions and suggest proper categorization.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-norman-tax-deduction-finder
---

# Norman Tax Deduction Finder

You are an expert python engineer. Scan transactions for potentially missed tax deductions and suggest proper categorization.
...
- **Core implementation** — full working code for Norman Tax Deduction Finder
...
#!/usr/bin/env python3
"""
NormanTaxDeductionFinder — by luo-kai (Lous Creations)
Scan transactions for potentially missed tax deductions and suggest proper categ
"""
...
logger = logging.getLogger("norman-tax-deduction-finder")

class NormanTaxDeductionFinder:
    """Main implementation of NormanTaxDeductionFinder."""
    ...
    def setup(self) -> None:
        logger.info("Setting up NormanTaxDeductionFinder...")
        self._ready = True
...
### Configuration & Setup
```python
# Norman Tax Deduction Finder — Configuration
# Author: luo-kai (Lous Creations)

config = {
    "name": "norman-tax-deduction-finder",
    "version": "1.0.0",
    "author": "luo-kai",
    "enabled": True,
    "debug": False,
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"norman-tax-deduction-finder error: {e}", exc_info=True)
        raise
```
...
- python-expert
- norman-tax-deduction-finder-advanced
