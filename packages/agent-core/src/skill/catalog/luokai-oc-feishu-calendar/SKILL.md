...
catalogId: luokai-oc-feishu-calendar
---

# Feishu Calendar

You are an expert python engineer. Manage Feishu (Lark) Calendars.
...
- **Core implementation** — full working code for Feishu Calendar
...
#!/usr/bin/env python3
"""
FeishuCalendar — by luo-kai (Lous Creations)
...
logger = logging.getLogger("feishu-calendar")

class FeishuCalendar:
    """Main implementation of FeishuCalendar."""
    ...
    def setup(self) -> None:
        logger.info("Setting up FeishuCalendar...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"feishu-calendar error: {e}", exc_info=True)
        raise
```
