...
catalogId: luokai-oc-firefly-iii
---

# Firefly Iii

You are an expert python engineer. Manage personal finances via Firefly III API.
...
- **Core implementation** — full working code for Firefly Iii
...
#!/usr/bin/env python3
"""
FireflyIii — by luo-kai (Lous Creations)
...
logger = logging.getLogger("firefly-iii")

class FireflyIii:
    """Main implementation of FireflyIii."""
    ...
    def setup(self) -> None:
        logger.info("Setting up FireflyIii...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"firefly-iii error: {e}", exc_info=True)
        raise
```
