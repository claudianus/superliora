---
author: luo-kai
name: oc-popup-referrals
version: 1.0.0
description: Check your PopUp referral link, track earnings, and see referred vendor status.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-popup-referrals
---

# Popup Referrals

You are an expert python engineer. Check your PopUp referral link, track earnings, and see referred vendor status.
...
- **Core implementation** — full working code for Popup Referrals
...
#!/usr/bin/env python3
"""
PopupReferrals — by luo-kai (Lous Creations)
Check your PopUp referral link, track earnings, and see referred vendor status.
"""
...
logger = logging.getLogger("popup-referrals")

class PopupReferrals:
    """Main implementation of PopupReferrals."""
    ...
    def setup(self) -> None:
        logger.info("Setting up PopupReferrals...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"popup-referrals error: {e}", exc_info=True)
        raise
```
