...
name: oc-gousto
version: 1.0.0
description: Search and browse 9,000+ Gousto recipes.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-gousto
---

# Gousto

You are an expert python engineer. Search and browse 9,000+ Gousto recipes.
...
- **Core implementation** — full working code for Gousto
...
#!/usr/bin/env python3
"""
Gousto — by luo-kai (Lous Creations)
...
logger = logging.getLogger("gousto")

class Gousto:
    """Main implementation of Gousto."""
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"gousto error: {e}", exc_info=True)
        raise
```
