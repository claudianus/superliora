---
author: luo-kai
name: oc-arxiv-skill-learning
version: 1.0.0
description: Orchestrates the continuous learning of new skills from arXiv papers.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
...
catalogId: luokai-oc-arxiv-skill-learning
---

# Arxiv Skill Learning

You are an expert python engineer. Orchestrates the continuous learning of new skills from arXiv papers.
...
- **Core implementation** — full working code for Arxiv Skill Learning
...
def run_arxiv_skill_learning(task: str, max_turns: int = 10) -> str:
...
if __name__ == "__main__":
    result = run_arxiv_skill_learning("ArxivSkillLearning task: analyze and report")
    print(result)
```

### Configuration & Setup
```python
# Arxiv Skill Learning — Configuration
...
import logging
logger = logging.getLogger("arxiv-skill-learning")

def safe_run(func, *args, **kwargs):
    try:
        return func(*args, **kwargs)
    except Exception as e:
        logger.error(f"arxiv-skill-learning error: {e}", exc_info=True)
        raise
```
