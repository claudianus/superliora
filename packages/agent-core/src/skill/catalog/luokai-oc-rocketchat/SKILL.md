...
catalogId: luokai-oc-rocketchat
---

# Rocketchat

You are an expert python engineer. Rocket.Chat team messaging - channels, messages, users, integrations via REST API.
...
- **Core implementation** — full working code for Rocketchat
...
#!/usr/bin/env python3
"""
Rocketchat — by luo-kai (Lous Creations)
Rocket.Chat team messaging - channels, messages, users, integrations via REST AP
"""
...
class Rocketchat:
    """Main implementation of Rocketchat."""
    ...
    def setup(self) -> None:
        logger.info("Setting up Rocketchat...")
        self._ready = True
...
def safe_run(func, *args, **kwargs):
    try:
        ...
        logger.error(f"rocketchat error: {e}", exc_info=True)
        raise
```
