...
catalogId: luokai-gtm-partner-affiliate
---
...
|---|---|
| Referral partner commission | 10-15% of first-year revenue |
| Integration partner commission | 20-25% of joint customer revenue, recurring |
| Solution partner commission | 30-40% of customer revenue, recurring |
| Partner activation rate benchmark | 20-30% of onboarded partners |
| Top performer concentration | 10-20% of partners drive 80%+ of revenue |
| Partner-sourced revenue target (mature) | 15-30% of total revenue |
| Deal registration protection window | 14 days for first-mover, 120 days to close |
| Time to first referral target | Under 30 days |
| Partner-sourced win rate vs. direct | 1.5-2x higher |
| Co-marketing budget per integration partner | $2K-$10K per quarter |
| Attribution cookie window | 90 days for referral links |
| Protected account limit per partner | 50 accounts maximum |
| QBR frequency | Quarterly for Tier 2 and Tier 3 partners |
| Platform ecosystem maturity | 36+ months to reach 30%+ revenue from partners |
| Affiliate platform for early-stage | Rewardful ($49/mo) or FirstPromoter ($99/mo) |
| Affiliate platform for growth-stage | PartnerStack or Impact.com |
