...
Multiple approaches: pass via `options` parameter. Before calling: in auto mode decide without AskUserQuestion; in yolo/manual resolve questions first. If rejected, revise based on feedback and call again.
