...
Provide both `library_name` (package/product name) and `query` (task/question — ranks matches by relevance). Pick the best match, then call Context7Docs with the library ID.
