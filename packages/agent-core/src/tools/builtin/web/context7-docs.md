...
Returns LLM-optimized snippets from indexed official docs — prefer over WebSearch/FetchURL for library APIs/config/code patterns. Use WebSearch/FetchURL for release notes, CVEs, papers, and other non-library facts.
