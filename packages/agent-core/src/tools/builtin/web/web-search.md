...
Host may use a local search provider when managed search is not configured. For implementation claims, follow hits with FetchURL and cite primary source URLs — do not rely only on snippets.
