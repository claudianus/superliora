...
- Do not create unsolicited documentation files (`*.md` write-ups, `README`s, summaries) unless the user asks or a task/project instruction requires it (e.g. plan file, changeset).
