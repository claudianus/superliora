...
- Scope/quality: Baseline + Upgrades (clear payoff)
- Prefer 2–4 options; single option only for explicit confirmation; open-ended: omit `options` so "Other" captures free text; 1–4 related questions/call
