Launch a subagent for a task — same-process loop, own context. Delegating keeps the bulk of intermediate file contents out of your own context; you get a conclusion back, not raw dumps.
