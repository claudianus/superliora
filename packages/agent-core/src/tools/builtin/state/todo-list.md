Live Kanban board for multi-step work — use proactively when tracking helps. Update when the work shape changes. In plan mode, write the durable plan to the plan file; TodoList is the execution board only.
...
**Start:** for 3+ step work, create 5–10 actionable cards before the first tool call.
