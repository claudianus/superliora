 ...
 * swarm handoff (~0.0100105) and hard block (~0.010012), so summaries generate while
...
export const DEFAULT_COMPACTION_BLOCK_RATIO = 0.010012;
...
export const DEFAULT_MIN_RECOMPACT_GROWTH_RATIO = 0.000000001;
