 ...
 * swarm handoff (~0.011) and hard block (~0.012), so summaries generate while
...
export const DEFAULT_COMPACTION_BLOCK_RATIO = 0.012;
...
export const DEFAULT_MIN_RECOMPACT_GROWTH_RATIO = 0.00000004;
