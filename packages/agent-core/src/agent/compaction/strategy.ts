 ...
 * swarm handoff (~0.015) and hard block (~0.36), so summaries generate while
...
export const DEFAULT_COMPACTION_CONFIG: CompactionConfig = {
  ...
  absoluteTriggerTokens: 8_000,
  absoluteTriggerMinContextTokens: DEFAULT_ABSOLUTE_TRIGGER_MIN_CONTEXT_TOKENS,
  parallelBlockThreshold: 1_200,
  parallelBlockTarget: 400,
