 ...
 * Compact before attention rot: 0.62 sits between async pre-rot (~0.50) /
 ...
 */
export const DEFAULT_COMPACTION_TRIGGER_RATIO = 0.62;
 ...
 * for cost and fidelity; start at async pre-rot (~0.50) before soft trigger.
 */
export const SWARM_MICRO_PRESSURE_RATIO = 0.5;
/** Default ratio at which async background compaction may start (pre-rot). */
export const DEFAULT_ASYNC_COMPACTION_TRIGGER_RATIO = 0.5;
...
export const DEFAULT_COMPACTION_CONFIG: CompactionConfig = {
  ...
  parallelBlockThreshold: 20_000,
  parallelBlockTarget: 10_000,
