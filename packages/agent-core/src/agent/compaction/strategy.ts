 ...
 * swarm handoff (~0.014) and hard block (~0.35), so summaries generate while
...
export const DEFAULT_COMPACTION_CONFIG: CompactionConfig = {
  ...
  absoluteTriggerTokens: 7_000,
  absoluteTriggerMinContextTokens: DEFAULT_ABSOLUTE_TRIGGER_MIN_CONTEXT_TOKENS,
  parallelBlockThreshold: 1_000,
  parallelBlockTarget: 350,
