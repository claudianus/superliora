 ...
 * swarm handoff (~0.011) and hard block (~0.18), so summaries generate while
...
export const DEFAULT_COMPACTION_BLOCK_RATIO = 0.18;
...
export const DEFAULT_MIN_RECOMPACT_GROWTH_RATIO = 0.000005;
