 ...
 * swarm handoff (~0.01005) and hard block (~0.0101), so summaries generate while
...
export const DEFAULT_COMPACTION_BLOCK_RATIO = 0.0101;
...
export const DEFAULT_MIN_RECOMPACT_GROWTH_RATIO = 0.000000006;
/** Pre-swarm handoff ceiling: force reclaim before UltraSwarm if usage is above this ratio. */
export const SWARM_HANDOFF_COMPACTION_RATIO = 0.01005;
/**
