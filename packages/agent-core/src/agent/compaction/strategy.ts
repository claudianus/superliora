 ...
 * swarm handoff (~0.44) and hard block (~0.80), so summaries generate while
...
export const DEFAULT_COMPACTION_BLOCK_RATIO = 0.80;
...
export const SWARM_HANDOFF_COMPACTION_RATIO = 0.44;
/**
