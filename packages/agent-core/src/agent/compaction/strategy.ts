 ...
 * swarm handoff (~0.011) and hard block (~0.25), so summaries generate while
...
export const DEFAULT_COMPACTION_CONFIG: CompactionConfig = {
  ...
  absoluteTriggerTokens: 1_000,
  absoluteTriggerMinContextTokens: DEFAULT_ABSOLUTE_TRIGGER_MIN_CONTEXT_TOKENS,
  parallelBlockThreshold: 250,
  parallelBlockTarget: 60,
