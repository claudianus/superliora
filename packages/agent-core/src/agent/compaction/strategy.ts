 ...
 * Compact before attention rot: 0.68 sits between async pre-rot (~0.58) /
 ...
 */
export const DEFAULT_COMPACTION_TRIGGER_RATIO = 0.68;
...
export const DEFAULT_SPECULATIVE_STEP_BUFFER_TOKENS = 4_000;
 ...
 * for cost and fidelity; start at async pre-rot (~0.58) before soft trigger.
 */
export const SWARM_MICRO_PRESSURE_RATIO = 0.58;
/** Default ratio at which async background compaction may start (pre-rot). */
export const DEFAULT_ASYNC_COMPACTION_TRIGGER_RATIO = 0.58;
...
export const DEFAULT_COMPACTION_CONFIG: CompactionConfig = {
  ...
  absoluteTriggerTokens: 160_000,
  absoluteTriggerMinContextTokens: DEFAULT_ABSOLUTE_TRIGGER_MIN_CONTEXT_TOKENS,
  parallelBlockThreshold: 24_000,
  parallelBlockTarget: 12_000,
