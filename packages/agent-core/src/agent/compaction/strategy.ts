 ...
 * swarm handoff (~0.02) and hard block (~0.41), so summaries generate while
...
export const DEFAULT_COMPACTION_CONFIG: CompactionConfig = {
  ...
  absoluteTriggerTokens: 14_000,
  absoluteTriggerMinContextTokens: DEFAULT_ABSOLUTE_TRIGGER_MIN_CONTEXT_TOKENS,
  parallelBlockThreshold: 2_200,
  parallelBlockTarget: 800,
