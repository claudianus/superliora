 ...
 * swarm handoff (~0.016) and hard block (~0.37), so summaries generate while
...
export const DEFAULT_COMPACTION_CONFIG: CompactionConfig = {
  ...
  absoluteTriggerTokens: 9_000,
  absoluteTriggerMinContextTokens: DEFAULT_ABSOLUTE_TRIGGER_MIN_CONTEXT_TOKENS,
  parallelBlockThreshold: 1_400,
  parallelBlockTarget: 450,
