 ...
 * swarm handoff (~0.50) and hard block (~0.84), so summaries generate while
...
export const SWARM_HANDOFF_COMPACTION_RATIO = 0.5;
/**
...
export const DEFAULT_COMPACTION_CONFIG: CompactionConfig = {
  ...
  parallelBlockThreshold: 16_000,
  parallelBlockTarget: 8_000,
