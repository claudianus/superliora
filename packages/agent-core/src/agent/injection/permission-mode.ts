...
const AUTO_MODE_ENTER_REMINDER = [
  ...
  '  - AskUserQuestion auto-answers structured questions (recommended option, else first; open-ended uses a conservative baseline). Destructive or irreversible decisions (delete, force push, merge/land approval, deploy, sharing secrets) are NEVER auto-answered — they always wait for the human. Ultra Plan interview still runs the same question flow.',
