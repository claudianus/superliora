...
export const NO_AI_SLOP_SKILL_ROUTING = [
  ...
  '- Trigger: final answers, docs, PR/changelog, TUI copy, plan text, benchmark reports, or UI/copy briefs — not every turn.',
  '- Surface → SearchSkill keywords (always include response language when not English):',
  '  - General prose audit: "avoid ai writing anti slop" + language',
  '  - Locale voice / UX microcopy: "anti slop locale voice UX copy" + language',
  '  - Visual / UI design: "anti slop ui design" (+ product domain if helpful)',
  '  - Changelog / PR / release: "anti slop changelog pr"',
  '  - Prompts / briefs: "anti slop meta prompt CRISP"',
  '  - Unsure: SearchSkill "no ai slop" → Skill("no-ai-slop") router',
  '- Load the best SearchSkill hit via Skill; prefer avoid-ai-writing for language-agnostic audit.',
