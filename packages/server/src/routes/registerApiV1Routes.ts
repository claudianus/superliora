...
import { registerApprovalsRoutes } from './agents/approvals';
import { registerAuthRoute } from './auth/auth';
import { registerConfigRoutes } from './meta/config';
import { registerConnectionsRoutes } from './auth/connections';
import { registerDebugRoutes } from './meta/debug';
import { registerFilesRoutes } from './fs/files';
import { registerFsRoutes } from './fs/fs';
